...
💡 **提示**
在参加正式考试时，您应始终密切关注投资者的**风险承受能力**、财务考量以及提到的风险，从而为特定的客户确定最佳投资方案。
...
💡 **提示**
大多数指数都是**针对大公司加权的**。这意味着大公司的价格变动对指数的影响更大。
...
🧠 **REMEMBER**
The Fed controls the **monetary policy**, but the **fiscal policy** is controlled by government politicians (Congress and the President).
*   **Monetary policy** = money supply, interest rates
*   **Fiscal policy** = borrowing, spending, taxes
🧠 **请记住**
美联储控制**货币政策**，而**财政政策**由政府政治人物（国会和总统）控制。
*   **货币政策** = 货币供应、利率
*   **财政政策** = 借贷、支出、税收
...
3.  **D.** Selling naked puts is a bullish strategy (the seller wants the stock to stay above the strike price to keep the premium). All others are bearish.
4.  **C.** The discount rate is the rate the Fed charges banks for loans. The Fed funds rate is what banks charge each other.
5.  **B.** Common stock has historically outpaced inflation, offering the best protection against purchasing power risk.
6.  **B.** Expansion is followed by a Peak, then Contraction, and finally a Trough.
7.  **B.** To ease money, the Fed **buys** securities (injects cash) and **lowers** reserve requirements (allows more lending).
8.  **A.** The prime rate is a lagging indicator. Money supply and stock prices are leading.
9.  **D.** GDP and GNP are measured in constant dollars to factor out inflation.
10. **C.** Dow Theory requires both the Industrial (DJIA) and Transportation averages to trend in the same direction to confirm a market trend.
