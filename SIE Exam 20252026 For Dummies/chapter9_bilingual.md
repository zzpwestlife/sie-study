...
通常，投资公司是以投资证券为业务的公司。因此，它们将从投资者那里收到的资金投资于大量不同的证券。每位投资者根据其在投资公司的权益分享利润或分担损失。1940 年《投资公司法》将投资公司分为三大类：**管理型投资公司**、**面值证单公司**和**单位投资信托**。本节重点讨论管理型投资公司，这是本章考查较多的领域。我将在随后名为“考虑其他投资公司选项”的部分介绍其他类型。
...
与面值证单公司和单位投资信托的投资者不同（见本章后面的“考虑其他投资公司选项”），开放式和封闭式基金的投资者有很多选择。投资者可能在寻求安全性、增长性或两者的结合等。本节将为您展示这些投资选择。
...
🧠 **请记住**
对于投资组合证券的客户来说，最重要的一项考量就是**基金的投资目标**。这一特征甚至超过了销售费用或管理费。如果您成为一名登记代表，您的主要职责之一就是帮助投资者决定哪种类型的基金最适合他们。出题者想知道您是否能胜任这项工作。
