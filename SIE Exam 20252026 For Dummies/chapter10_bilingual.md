...
DPP 曾因其对投资者的税务优惠而被誉为“**避税工具 (tax shelters)**”，但税法的变更已经取消了其中的许多优势。结果，DPP 在投资者中有些失宠（尽管在 SIE 考试出题者眼中并非如此）。
...
🧠 **请记住**
出于 SIE 考试的目的，您需要记住：合伙企业最容易避开的公司特征是**永久寿命（寿命的连续性）**和**股份的自由转让性**；最难避开的是提供有限责任和具有集中管理。
...
作为一名登记代表，您的职责之一是对潜在有限合伙人进行**预先筛选**，以确保该合伙企业适合该人。请考虑以下问题：
...
*   **耗竭补偿 (Depletion)：** 耗竭补偿是一种税收抵扣，允许经营自然资源（如石油和天然气）的合伙企业因资源供应量减少而进行抵扣。合伙企业只能对已售出的自然资源量申请耗竭补偿抵扣（未提取或存放在仓库待售的资源不在此列）。
...
🧠 **请记住**
耗竭补偿抵扣仅适用于经营自然资源的 DPP。在 SIE 考试中，您唯一需要关注的具有耗竭补偿抵扣的 DPP 是石油和天然气。
...
4.  **A.** Exploratory programs are the riskiest because the partnership is drilling in unproven areas trying to find oil.
5.  **D.** To officially accept a new limited partner to the partnership, a general partner must sign the subscription agreement.
6.  **B.** The easiest corporate characteristics for a partnership to avoid are having a perpetual life and having free transferability to partnership interest.
7.  **D.** All the choices listed are benefits of investing in a limited partnership. Investors get professional management, pass-through treatment, and limited liability.
8.  **C.** The partnership agreement lays out the rights and responsibilities of the limited and general partner(s).
9.  **D.** To claim depletion deductions, the partnership has to be depleting a natural resource. Oil and gas income programs are the primary candidates.
10. **A.** Both equity REITs and hybrid REITs derive part of their income from rent collected from property that is owned.
