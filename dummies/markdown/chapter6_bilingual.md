...
权益证券——如普通股和优先股——代表发行公司的所有权权益。所有公众持股公司都会向投资者发行普通股。投资者喜爱这些证券，因为从历史上看，它们的表现优于大多数其他投资，因此，一名普通（或者对您来说，是水平以上）的股票经纪人通常销售这类证券的数量比任何其他种类都多。
...
SIE 考试会测试您识别权益证券类型和其他一些基本信息的能力。虽然您可能会发现 SIE 考试对本章提供的信息考核并不沉重，但本章为本书中的许多其他章节打下了坚实的基础，同时也为您在之后可能参加的其他证券考试奠定了良好的基础。就论证而言，我认为如果您不知道什么是股票，您将很难（甚至不可能）理解什么是期权或共同基金。不用说，尽管本章篇幅较小，也不要忽视它；否则，它可能会在以后让您吃苦头。
...
股东拥有**检查权 （right of inspection）**。这意味着他们有权检查发行人的某些账簿和记录。这些包括股东名册和股东大会会议纪要。这些信息通常可以通过经审计的年度报告获得。
...
股东享有**有限责任 （limited liability）**。股东的责任仅限于其投资金额。换句话说，如果您投资的公司倒闭了（第 11 章破产保护），您只会损失投资的那部分；没有人会找上门来向您索要额外的钱。然而，如果一家公司不幸破产，它必须按照以下方式分配任何剩余资产（也称为**清算顺序**）：


1.  Unpaid workers （未付工资的员工）
2.  The Internal Revenue Service （IRS） （美国国税局）
3.  Secured creditors： Secured creditors have issued loans that are secured with collateral， bonds， and so on。 （有担保债权人：已发放由抵押品、债券等担保的贷款的债权人。）
4.  General creditors： General creditors have issued unsecured loans， which aren't secured with collateral （bank loans， accounts payable， debentures， and so on）。 （一般债权人：已发放无担保贷款的债权人，这些贷款没有抵押品担保，如银行贷款、应付账款、无抵押信用债券等。）
5.  Subordinated debentures： Subordinated debentures are junior unsecured bonds； holders of subordinated debentures are the last creditors to be paid in the event of corporate bankruptcy。 （次级信用债券：次级信用债券是次等无担保债券；在公司破产的情况下，次级信用债券持有者是最后获得赔付的债权人。）
6.  Preferred stockholders （优先股股东）
7.  Common stockholders （普通股股东）
...
🧠 **请记住**
普通股和优先股股东将在债权人之后获得赔付（如果还有剩余资金的话）。普通股股东拥有所谓的**剩余索赔权 （residual rights）**，这意味着在公司破产的情况下，他们是最后获得赔付的。相对于普通股，债券和优先股被认为是**高级证券 （senior securities）**。
...
当投资者拥有投票权时，公司会不时让这些投资者投票更换董事会成员。虽然投资者可能可以就其他事项进行投票，如股票拆分（见本章后面的“拆分普通股”），但 SIE 考试的重点是投票更换董事会成员。
...
If an investor owns 1,000 shares, and three positions on the board of directors are open, the investor has a total of 3,000 votes (1,000 shares × 3 candidates), which the investor can use to vote for any candidate(s) in any way they see fit.
如果一名投资者持有 1,000 股，且董事会有三个席位空缺，则该投资者总共有 3,000 票（1,000 股 × 3 名候选人），投资者可以按照自己认为合适的方式将这些票投给任何候选人。
...
🧠 **请记住**
累积投票并不会给投资者带来更多的投票权——只是提供了更多的投票灵活性。获得更多投票权的唯一方法是购买更多股份。
...
现在，假设您住在纽约市，而投票在洛杉矶进行。您该怎么办？好吧，除了横跨全国跑一趟之外，您还可以通过**代理投票 （proxy）**（基本上是缺席选票）进行投票。发行人会向您发送一份委托书，其中描述了待投票的事项。您可以勾选描述您投票意愿的方框，然后将委托书寄回。通过这样做，您是在授权（给予有限授权书）另一个人按照您的意愿进行投票。**过户代理人 （transfer agent）** 负责寄送委托书。
...
这是一个关于计算流通股份的快速问题。看看你做得如何：


DEF Corp. has 20,000,000 shares of authorized stock. DEF has issued 15,000,000 shares and has since repurchased 1,500,000 shares. How many shares are outstanding? DEF 公司拥有 20,000,000 股授权股票。DEF 已发行 15,000,000 股，此后回购了 1,500,000 股。流通股份有多少？
...
### Establishing the par value of common stock 确定普通股的面值


Par value (nominal or original value) for common stock is more or less a bookkeeping value for the issuer. Although issuers may set the par value at $1 (or 1 cent, $5, $10, or whatever), the market price is usually much more. A common stock's par value has no relationship with the market price of the stock. Although much rarer, some companies even issue stock with no par value. Par value for common stock isn't as important to investors as it is to bondholders and preferred stockhold- ers (see "Considering characteristics of preferred stock" later in this chapter).
普通股的面值（名义价值或原始价值）对发行人来说更多是一个账面价值。虽然发行人可以将面值定为 1 美元（或 1 美分、5 美元、10 美元或其他任何金额），但市场价格通常要高得多。普通股的面值与股票的市场价格没有关系。虽然比较罕见，但有些公司甚至发行无面值股票。普通股的面值对投资者来说并不像对债券持有人和优先股股东那样重要（参见本章后面的“考虑优先股的特征”）。


The amount over par value that an issuer receives for selling stock is called additional paid-in capi- tal, paid-in surplus, or capital in excess of par.
发行人出售股票所获得的超过面值的金额称为**资本公积 (additional paid-in capital)**、**实收盈余 (paid-in surplus)** 或 **超过面值的资本 (capital in excess of par)**。
...
规定的面值印在股票证书上；它可能会因公司行为（如股票拆分）而改变（参见本章后面的“拆分普通股”）。发行人也可以发行无面值股票（没有规定面值的股票）；在这种情况下，股票有一个公司用于记账目的的规定价值。没有面值并不影响投资者。


### Considering corporate actions 考虑公司行为
...
除了试图建立业务外，公司可能会采取其他影响其证券价格的行动。它们可以拆分股票（见下一节“拆分普通股”）；反向拆分股票（见“反向股票拆分”一节）；或进行回购、要约收购、交换要约、配股发行（见后面的“配股：以折扣价购买新股的权利”一节）、合并或收购。
...
*   **Buybacks (回购):** A buyback happens when a cash-rich corporation repurchases some of its own shares in the market, turning them into treasury stock. Buybacks typically increase the market value of the underlying security. After a successful buyback, fewer shares are outstanding.
    *   **回购：** 回购发生在现金充裕的公司回购部分自己的市场上的股票，将其转为库存股时。回购通常会增加标的证券的市场价值。成功回购后，流通股数量减少。


*   **Tender offers (要约收购):** A tender offer occurs when a corporation, person, or group attempts to gain control (make a takeover bid) of a corporation (the target corporation). A tender offer is typically announced in financial publications, and the offer will be at a premium to the market value of the securities. Tender offers are good for a specified period and specified minimum number of holders of shares (in other words, holders of more than 50 percent of the outstanding shares of the target corporation) must agree; otherwise, the offer is canceled. Tender offers increase the market price of the securities being targeted.
    *   **要约收购：** 要约收购发生在一家公司、个人或团体试图获得一家公司（目标公司）的控制权（发出收购要约）时。要约收购通常在金融刊物上宣布，报价将高于证券的市场价值。要约收购在特定期限内有效，并且必须有特定最低数量的股份持有人（换句话说，持有目标公司 50% 以上流通股的持有人）同意；否则，要约将被取消。要约收购会增加被目标证券的市场价格。


*   **Exchange offers (交换要约):** Sometimes, a corporation decides to exchange some of its securities for other ones. A corporation may offer its bondholders the right to exchange certain debt securities for stock to reduce the corporation's debt. Or a corporation may offer to exchange 4 percent bonds due to mature in 2 years with 5 percent bonds due to mature in 20 years, thus extending the amount of time the corporation has to pay back its debt.
    *   **交换要约：** 有时，一家公司决定将其部分证券交换为其他证券。公司可以向其债券持有人提供将某些债务证券交换为股票的权利，以减少公司的债务。或者，公司可以提议将 2 年后到期的 4% 债券交换为 20 年后到期的 5% 债券，从而延长公司偿还债务的时间。


*   **Mergers (合并):** Two existing corporations may decide to merge their two companies, often to gain market share, expand one corporation's reach, or possibly to expand into new segments. Mergers typically have a positive impact on investors.
    *   **合并：** 两家现有公司可能决定合并为一家公司，通常是为了获得市场份额、扩大一家公司的覆盖范围，或者可能为了扩展到新的领域。合并通常对投资者产生积极影响。


*   **Acquisitions (收购):** Compared with a merger, in which two corporations work together to make one big corporation, an acquisition happens when a larger corporation takes control of a smaller one or a portion of another corporation. For one corporation to acquire another, it must obtain majority ownership of the target corporation.
    *   **收购：** 与合并（两家公司合作成为一家大公司）相比，收购发生在一家较大的公司控制了一家较小的公司或另一家公司的一部分时。要收购另一家公司，它必须获得目标公司的多数所有权。
...
可以想象，在发生股票拆分、合并、收购等公司行为时，必须通知证券投资者。对于在纽约证券交易所 (NYSE) 等交易所上市的上市公司，交易所负责通知客户并在线提供信息。如果证券在场外交易 (OTC)，金融业监管局 (FINRA) 负责处理公告。


### Splitting common stock 拆分普通股
...
你可能会问“为什么一家公司要拆分其股票？”显然，除了向投资者展示公司正在成长外，它还使证券的市场价格更具吸引力。正常的交易单位是 100 股（一手），如果证券的股价过高，能够购买它的投资者数量就会受到限制。如果微软从未拆分其股票（它已经拆分了九次，全部是 2 拆 1 或 3 拆 2，最后一次是在 2003 年），一手股票将花费投资者接近 1000 万美元。认识很多买得起那个的投资者吗？
...
或者，公司可能会使用反向拆分，合并股份以提高股票价格，或许是为了防止股价跌得太低并可能面临退市。接下来的几节将带你了解拆分，以便你对其了如指掌。
...
股东可以对股票拆分进行投票。（参考本章前面的“了解股东的投票权”，了解投票类型的信息。）请注意，股票拆分后，投资者可能拥有更多或更少的选票，但他们仍然持有相同比例的选票。当一家公司拆分其股票时，需要在公司章程中更改授权股份的数量（参考本章前面的“公司可售股份的分类”）。


### Forward stock splits 正向股票拆分
...
在正向股票拆分（或简称拆分）期间，股份数量增加，价格下降，而不影响流通股的总市值。公司正向拆分股票后，投资者收到额外的股份，但每股的市场价格（和面值）下降。正向拆分可以是偶数（2 拆 1、3 拆 1、4 拆 1 等）或奇数（3 拆 2、5 拆 3、5 拆 2 等）。你会发现，无论正向拆分是偶数还是奇数，同样的公式都适用。查看以下公式，其中 A 代表第一个数字，B 代表第二个数字。


Use the following calculations to figure out an investor's position after an A-for-B split:
使用以下计算来弄清楚投资者在 A 拆 B 后的头寸：
...
Bob Billingham 拥有 1,200 股 DEF 普通股，当前市场价格为每股 90 美元。如果 DEF 进行 3 拆 1 的股票拆分，Bob 拆分后的头寸是多少？


(A) 400 shares at $270 per share (400 股，每股 270 美元)


(B) 400 shares at $90 per share (400 股，每股 90 美元)


(C) 3,600 shares at $33.33 per share (3,600 股，每股 33.33 美元)


(D) 3,600 shares at $30 per share (3,600 股，每股 30 美元)
...
你要找的答案是 (D)。正向股票拆分（如 3 拆 1）会增加股份数量并降低股票价格，因此你可以立即划掉 (A) 和 (B)。选项 (C) 不正确，因为股票价格必须是 90 美元的 1/3，即 30 美元，而不是 33.33 美元。现在检查你的计算：


**1,200 shares x (3/1) = 3,600 shares**
**1,200 股 x (3/1) = 3,600 股**
...
A good way to double-check your work is to make sure that the overall value of the investment doesn't change after the split. Using the example, Bob had $108,000 worth of DEF (1,200 shares x $90) before the split, and after the split, Bob has $108,000 worth of DEF (3,600 shares x $30).
仔细检查你的工作的一个好方法是确保拆分后投资的总价值没有改变。使用该示例，Bob 在拆分前拥有价值 108,000 美元的 DEF（1,200 股 x 90 美元），拆分后，Bob 拥有价值 108,000 美元的 DEF（3,600 股 x 30 美元）。


### Reverse stock splits 反向股票拆分
...
反向股票拆分对证券的影响与正向拆分相反。在反向拆分中，证券的市场价格上涨，股份数量减少。与正向股票拆分一样，证券的总市值不变。如果市场价格过低，公司可能会反向拆分其股票，这可能会让潜在投资者认为公司有问题。
...
Betty Billings 拥有 3,600 股 GHI 普通股，当前市场价格为每股 2 美元。如果 GHI 进行 1 拆 5 的反向股票拆分，Betty 拆分后的头寸是多少？


(A) 600 shares at $10 per share (600 股，每股 10 美元)


(B) 720 shares at $10 per share (720 股，每股 10 美元)


(C) 18,000 shares at 40 cents per share (18,000 股，每股 40 美分)


(D) 18,000 shares at $10 per share (18,000 股，每股 10 美元)
...
正确答案是 (B)。在反向拆分中，股份数量必须减少，价格必须上涨，因此你可以立即排除 (C) 和 (D)。选项 (A) 不正确，因为投资者最终得到的股份太少。检查你的计算：


**3,600 shares x (1/5) = 720 shares**
**3,600 股 x (1/5) = 720 股**


**$2 x (5/1) = $10**
**$2 x (5/1) = $10**
### Sharing corporate profits through dividends 通过股息分享公司利润
...
如果公司盈利（并且董事会心情愉快），董事会可能会决定向投资者发放股票股息。如果公司宣布分红，每位股东都有权获得按比例分配的股息，这意味着每位股东拥有的每股股票都能获得相同比例的股息。SIE 考试希望你知道投资者可以获得的股息形式，以及股息如何影响股票的市场价格和投资者的头寸。虽然投资者可以获得现金、股票或财产形式的股息（子公司的股票或发行人制造的样品产品），但我主要关注现金股息和股票股息，因为这些情况更为常见。
...
投资者不能对股息进行投票；相反，由董事会决定股息支付。你可以想象，如果这个决定权留给投资者，他们会每周都投票要求分红！有关投票的更多信息，请参阅本章前面的“了解股东的投票权”。即使是盈利的公司也可能不支付现金股息，因为它们可能希望将利润再投资回公司。


### Cash dividends 现金股息


Cash dividends are a way for a corporation to share its profits with shareholders. When an inves- tor receives cash dividends, the payout is a taxable event. Corporations aren't required to pay dividends, but dividends provide a good incentive for investors to hold onto stock that isn't expe- riencing much growth. Although cash dividends are nice, the market price of the stock falls on the ex-dividend date (the first day the stock trades without a dividend) to reflect the dividend to be paid on the payment date announced:
现金股息是公司与股东分享利润的一种方式。当投资者收到现金股息时，这是一项应税事件。公司不被要求支付股息，但股息为投资者持有增长不快的股票提供了良好的激励。虽然现金股息很好，但股票的市场价格在除息日（股票在没有股息的情况下交易的第一天）会下跌，以反映将在宣布的支付日支付的股息：
...
📝 **QUESTION**
The closing price for ABC stock is $49.50 on the day before the ex-dividend date. If ABC previ- ously announced a dividend of 75 cents, what will the next day's opening price be?
ABC 股票在除息日前一天的收盘价为 49.50 美元。如果 ABC 此前宣布了 75 美分的股息，第二天的开盘价将是多少？
...
公司向投资者发放股票股息的主要原因是使市场价格对投资者更具吸引力（如果市场价格过高，会限制能够购买该股票的投资者数量），从而增加股票的流动性（交易的便利性）。


The following question tests your expertise in answering stock-dividend questions.
以下问题测试你回答股票股息问题的专业知识。
...
Alyssa H. 拥有 400 股 OXX 普通股，每股 33 美元。OXX 此前宣布了 10% 的股票股息。假设 OXX 的市场价格在股息前没有变化，Alyssa 在股息后的头寸是多少？


(A) 400 shares at $30 (400 股，每股 30 美元)


(B) 440 shares at $33 (440 股，每股 33 美元)


(C) 400 shares at $36.30 (400 股，每股 36.30 美元)


(D) 440 shares at $30 (440 股，每股 30 美元)
...
你要找的答案是 (D)。在这种情况下，你不需要做任何数学运算就能找到答案。因为股份数量增加，股票价格必须下降。因此，唯一可行的答案是 (D)。我不能保证你会遇到不需要做数学运算的问题，但不要排除这种可能性；在拿出计算器之前扫描一下答案选项。
...
无论如何，这是数字的运作方式。你必须记住，投资者的总投资价值没有改变。Alyssa 获得 10% 的股票股息，所以她收到 10% 更多的股份。现在 Alyssa 拥有 440 股 OXX（400 股 + 40 股 [400 的 10%]）。接下来，你需要确定她的总投资价值：


**400 shares x $33 = $13,200**


Because the overall value of investment doesn't change, Alyssa needs to have $13,200 worth of OXX after the dividend:
因为总投资价值没有改变，Alyssa 在股息后需要拥有价值 13,200 美元的 OXX：
...
当你或你的客户拥有的证券受到拆分、股票股息、合并等公司行为的影响时，证券将发生变化。在某些情况下，如正向股票拆分和股票股息，你或你的客户将以较低的成本基础收到更多股份，持有的股份的成本基础将相应降低。在确定资本收益或损失金额时，成本基础的调整对于税务目的很重要。
...
为了论证起见，假设你以每股 40 美元购买了 1,000 股 UPPP 公司的股票。在这种情况下，你持有的股票成本基础为 40,000 美元（1,000 股，每股 40 美元）。如果股票进行 2 拆 1，你每购买 1 股就有 2 股。公司不仅仅是再给你价值 40,000 美元的股票；它将价格减半以适应拆分。随着市场价格减半，每股的成本基础也减半。在该示例中，现在你拥有 2,000 股，成本基础为每股 20 美元（40,000 美元成本基础），即使市场价值为 55,000 美元。在发生拆分时，发行人将调整你的股份以反映较低的面值。在发生交换要约、合并或收购时，你持有的证券可能会发生变化。在这种情况下（假设你实际持有证券），发行人将负责邮寄新证券。无论证券是实际持有（这种情况越来越少见）还是以记账形式持有，发行人都必须更新其账簿以反映任何变化。
...
Equity securities represent shares of ownership in a company, and debt securities repre- sent . . . well, debt. (See Chapters 7 and 8 for info on debt securities.) Although preferred stock (sometimes called preferreds) has some characteristics of both equity and debt securities, preferred stock is an equity security because it represents ownership of the issuing corporation the same way that common stock does.
...
Because preferred stocks receive (or are supposed to receive) a consistent dividend, they’re some- what like debt securities receiving interest. Because of that similarity, like debt securities (bonds), many preferred stocks are rated by rating agencies such as Moody’s, Standard & Poor’s, and Fitch. (For more on rating agencies, see Chapter 7.) Some of the drawbacks of investing in preferred stock instead of common stock are the lack of voting rights, the sometimes-higher cost per share, and lack of growth. You can assume for SIE exam purposes that preferred stockholders don’t receive voting rights unless they fail to receive their expected dividends. (A few other exceptions exist, but you don’t need to worry about them now.) Also, because most preferred stock pays consistent dividends, the market price will increase or decrease depending on prevailing interest rates similar to debt securities.
由于优先股收到（或应该收到）持续的股息，它们有点像接收利息的债务证券。由于这种相似性，像债务证券（债券）一样，许多优先股由评级机构（如穆迪、标准普尔和惠誉）进行评级。（有关评级机构的更多信息，请参见第 7 章。）


If the issuer can’t make a payment because earnings are low, and if the preferred stock is cumula- tive (see “Getting familiar with types of preferred stock,” the next section in this chapter), own- ers are still owed the missing dividend payment(s). The dividend (sharing of profits) that preferred stockholders receive is based on par value. Thus, although par value may be nothing more than a bookkeeping value when you’re dealing with common stock, par value is definitely important to preferred stockholders.
...
The right answer is (D). Because ABC is cumulative preferred stock, issuers have to catch up pre- ferred stockholders on all outstanding dividends before common shareholders receive a dividend. In this example, the investor is supposed to receive $8 per year in dividends (8 $100 par). In the first year, the issuer shorted the investor $2; in the second year, $4. The investor hasn’t yet received payment for the following year, so they are owed $8. Add up these debts:
...
**$8 (current year) + $2 (arrears year 1) + $4 (arrears year 2) = $14**
$8 （当年） + $2 （第一年欠款） + $4 （第二年欠款） = $14


All preferred stock has to be either cumulative or noncumulative. Both types may have other fea- tures, including the capability to turn into other kinds of stock, offerings of extra dividends, and other VIP treatment. I run through some of these traits in the list that follows:
...
6.  Which of the following are true regarding ADRs?
    ...
    IV. They’re subject to currency risk.
    (Note: Dividends are paid in the foreign currency. - This statement appears in source but is false here.) （它们面临货币风险。）
...
7.  Declan Hudson owns 1,200 shares of ABCD Corporation common stock. ABCD announces a 1-for-2 reverse-split. If the price of ABCD closed at $10 the day before the split, what would Declan’s position be after the split?
    Declan Hudson 拥有 1,200 股 ABCD 公司普通股。ABCD 宣布进行 1 拆 2 的反向拆分。如果拆分前一天 ABCD 的收盘价为 10 美元，拆分后 Declan 的头寸是多少？
...
8.  An investor purchased 200 shares of DDD common stock at $41 per share. DDD previously announced a 5 percent stock dividend payable to shareholders of record. On the date before the ex-dividend date, DDD closed at $44 per share. What would the investor’s position be on the ex-dividend date?
    一位投资者以每股 41 美元的价格购买了 200 股 DDD 普通股。DDD 此前宣布向登记在册的股东支付 5% 的股票股息。在除息日的前一天，DDD 收盘价为每股 44 美元。除息日投资者的头寸是多少？
...
9.  WXY Corporation common stock closed at $45 on the business day before the ex-dividend date. If WXY previously announced a 77-cent dividend, at what price will the stock open the next trading day?
    WXY 公司普通股在除息日前一个交易日收盘价为 45 美元。如果 WXY 此前宣布了 77 美分的股息，下一个交易日股票将以什么价格开盘？
...
10. A corporation has issued 6 percent $100 par cumulative preferred stock. It paid $4 in dividends the first year and $3 in dividends the second year. If the corporation wants to declare a dividend for common shareholders the following year, how much must it pay per share to its cumulative preferred stockholders?
    一家公司发行了 6% 的 100 美元面值累积优先股。第一年支付了 4 美元的股息，第二年支付了 3 美元的股息。如果公司希望在次年向普通股股东宣派股息，它必须向其累积优先股股东支付每股多少钱？
...
14. STU Corporation would like to offer its existing shareholder the privilege to purchase additional shares at a fixed price. Which of the following securities would STU issue?
    STU 公司希望向其现有股东提供以固定价格购买额外股份的特权。STU 将发行以下哪种证券？
...
15. Under statutory voting, an individual stockholder may vote for each vacancy on the board of directors equal to
    在法定投票制下，个人股东可以为董事会的每个空缺职位投出的票数等于
...
17. In June, JKL Corporation announced a 20 percent stock dividend for its common shareholders. Ayla K. holds 2,000 shares of JKL common stock at $40 per share. After payment of the dividend, what would Ayla’s new price per share be and how many shares would she be holding?
    6 月，JKL 公司宣布向其普通股股东派发 20% 的股票股息。Ayla K. 持有 2,000 股 JKL 普通股，每股 40 美元。支付股息后，Ayla 的新每股价格是多少，她将持有多少股份？


    (A) 1,600 shares at $48.00
    （A） 1,600 股，每股 48.00 美元


    (B) 2,000 shares at $32.00
    （B） 2,000 股，每股 32.00 美元


    (C) 2,400 shares at $32.00
    （C） 2,400 股，每股 32.00 美元


    (D) 2,400 shares at $40.00
    （D） 2,400 股，每股 40.00 美元
...
18. If a corporation were to go bankrupt, which of the following entities would have the highest claim on the assets in a Chapter 11 proceeding?
    如果一家公司破产，在第 11 章诉讼程序中，以下哪个实体对资产拥有最高索赔权？
...
7.  **(D) 600 shares at $20.** Because ABCD is doing a reverse-split, Declan would have fewer shares after the split, and the price of the stock would increase. This transaction is a 1-for-2 reverse-split, so to determine the shares, you have to multiply them by 1 divided by 2. To get the price, you have to multiply it by 2 divided by 1.
    **(D) 600 股，每股 20 美元。** 因为 ABCD 正在进行反向拆分，Declan 在拆分后拥有的股份会减少，而股价会上涨。这笔交易是 1 拆 2 的反向拆分，因此要确定股份，必须将其乘以 1/2。要获得价格，必须将其乘以 2/1。


8.  **(D) 210 shares at $41.90 per share.** You can cross out two answers to this question without doing the math. The investor received a stock dividend, so the number of shares had to increase. Therefore, (A) and (B) are out. Next, ignore the purchase price; you have to look at the overall value of the investment on the day before the ex-dividend date (the first day the stock trades without a dividend). In this case, the investor had 200 shares at $44 per share. You can see that the investor had an overall value of investment on the day before the ex-dividend date of $8,800. That doesn’t change due to the dividend. So, on the ex-dividend date, the investor still had $8,800 worth of stock. Now, however, the investor has 210 shares (200 shares + 10 shares [5% of 200]). By dividing the $8,800 shares by 210 shares, you’ll get a price of $41.90 per share:
    **(D) 210 股，每股 41.90 美元。** 您可以在不进行计算的情况下划掉此问题的两个答案。投资者收到了股票股息，因此股份数量必须增加。因此，(A) 和 (B) 被排除。接下来，忽略购买价格；您必须查看除息日前一天（股票在没有股息的情况下交易的第一天）的投资总价值。在这种情况下，投资者拥有 200 股，每股 44 美元。总价值 = 8,800 美元。5% 股息后，股份 = 210。8,800 美元 / 210 = 41.90 美元。


9.  **(B) 44.23.** On the ex-dividend date, the stock would be reduced by the amount of the dividend. $45 - $0.77 = $44.23.
    **(B) 44.23。** 在除息日，股票价格将减去股息金额。45 美元 - 0.77 美元 = 44.23 美元。


10. **(C) $11.** Because the stock is cumulative preferred stock, the corporation must make up any missed dividends to its cumulative preferred stockholders before paying a dividend to its common stockholders. In the first year, the corporation shorted its preferred stockholders $2 per share ($6 - $4). In the second year, it shorted them $3 ($6 - $3). Total arrears = $5. Plus current year $6. Total = $11.
    **(C) $11。** 由于该股票是累积优先股，公司必须在向普通股股东支付股息之前，向其累积优先股股东补足任何漏发的股息。第一年，公司每股欠优先股股东 2 美元（6 美元 - 4 美元）。第二年，欠 3 美元（6 美元 - 3 美元）。总拖欠 = 5 美元。加上当年的 6 美元。总计 = 11 美元。


11. **(A) Callable preferred.** Callable preferred stock allows the issuer to buy back the preferred stock at any time after a defined date. This stock is a little riskier for investors, so corporations usually pay a higher dividend on callable preferred stock.
    **(A) 可赎回优先股。** 可赎回优先股允许发行人在规定日期后的任何时间回购优先股。这种股票对投资者来说风险稍大，因此公司通常对可赎回优先股支付更高的股息。


12. **(C) Common stockholders.** For the SIE exam, you can assume that common stockholders automatically receive rights.
    **(C) 普通股股东。** 对于 SIE 考试，您可以假设普通股股东会自动获得配股权。


13. **(D) All of the above.** Warrants allow shareholders to purchase shares of a corporation at a fixed price and are typically bundled with a stock or bond offering to sweeten the deal. Warrants are long-term and sometimes perpetual. Because they can be traded separately, they’re marketable securities.
    **(D) 以上所有。** 认股权证允许股东以固定价格购买公司股份，通常与股票或债券发行捆绑在一起以增加吸引力。认股权证是长期的，有时是永久的。因为它们可以单独交易，所以它们是有价证券。


14. **(C) Rights.** If a corporation would like to offer its existing shareholders the right to purchase additional shares at a fixed price, they would have a rights offering.
    **(C) 配股权。** 如果公司希望向其现有股东提供以固定价格购买额外股份的权利，他们将进行配股发行。


15. **(C) the number of shares owned by the stockholders.** Under statutory (regular) voting rules, individual stockholders may vote up to the amount of shares they own for each open position on the board of directors.
    **(C) 股东拥有的股份数。** 根据法定（常规）投票规则，个人股东可以为董事会的每个空缺职位投出不超过其拥有股份数量的选票。


16. **(B) The price of their common stock decreases.** When a corporation splits its stock (2-for-1, 3-for-1, 3-for-2, and so on), the price of the stock decreases, and the amount of shares each shareholder has increases.
    **(B) 其普通股价格下跌。** 当一家公司拆分其股票（2 拆 1、3 拆 1、3 拆 2 等）时，股票价格下跌，每位股东拥有的股份数量增加。


17. **(C) 2,400 shares at $32.00.** In this case, you didn’t even have to do the math. They’re giving Ayla a 20 percent stock dividend, so she will have more shares. This eliminates answers A and B. If they’re increasing the amount of shares, the price has to decrease.
    **(C) 2,400 股，每股 32.00 美元。** 在这种情况下，您甚至不需要进行计算。他们给 Ayla 20% 的股票股息，所以她会有更多的股份。这排除了答案 A 和 B。如果他们增加股份数量，价格必须下降。


18. **(C) Secured debt holders.** In a Chapter 11 proceeding, debt holders have a higher claim on the corporation’s assets than shareholders. And, secured debt holders (debt secured with collateral), would have a higher claim on the assets than unsecured debt holders.
    **(C) 有担保债务持有人。** 在第 11 章诉讼程序中，债权人对公司资产的索赔权高于股东。而且，有担保债权人（以抵押品担保的债务）对资产的索赔权高于无担保债权人。
