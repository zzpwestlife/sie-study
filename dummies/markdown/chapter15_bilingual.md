...
## 1. Everything in Its Place: Checking Out Tax and Income Categories 1. 各就各位：查看税收与收入类别

The Internal Revenue Service (IRS) likes to break things into categories.
美国国税局 （IRS） 喜欢将事物分类。


### Touring the tax categories 巡览税收类别
...
### Looking at types of income 审视收入类型
...
## 2. Noting Taxes on Investments 2. 记录投资税收
...
🧠 **请记住**
尽管零息债券不产生定期的利息支付，但购买价格与到期收到的金额之间的差额被视为利息，且需缴纳税款。
...
## 3. Capital gains and losses 3. 资本利得与损失
...
### Offsetting gains with capital losses 用资本损失抵销利得

Investors can use capital losses to offset capital gains and reduce the tax burden.
投资者可以利用资本损失来抵销资本利得，从而减轻税收负担。

🧠 **REMEMBER**
When an investor has a **net capital loss**, they can write off up to **$3,000 per year** on their federal taxes against their earned income and carry the balance forward to the following year.
🧠 **请记住**
当投资者产生**净资本损失**时，他们每年最多可以在联邦税中用 **3,000 美元**抵扣其劳动收入，并将余额结转至下一年。

📝 **EXAMPLE**
In a particular year, Jones realizes $30,000 in long-term capital gains and $50,000 in long-term capital losses. How much of the capital losses would be carried forward to the following year?
(A) $3,000 (B) $17,000 (C) $20,000 (D) $30,000
The correct answer is (B). Jones has a net capital loss of $20,000 ($50,000 loss minus the $30,000 gain). Jones writes off $3,000 of that capital loss against the earned income and carries the additional loss of $17,000 forward.
...
### The wash sale rule 洗售规则 (Wash sale rule)
...
根据此规则，如果投资者以资本损失卖出证券，则在**卖出前 30 天或卖出后 30 天内**，不能买回相同的证券或任何可转换为该证券的资产，否则无法申报该损失。

🧠 **REMEMBER**
The total "wash sale window" is **61 days** (30 days before, 30 days after, plus the trade date).
🧠 **请记住**
整个“洗售窗口期”为 **61 天**（卖出前 30 天、卖出后 30 天，加上交易当天）。

---


## 4. Exploring Retirement Plan Tax Advantages 4. 探索退休计划的税收优势
...
### IRA types and contribution limits IRA 类型与缴款限额
...
### Simplified employee pensions (SEP-IRAs) 简化员工养老金 (SEP-IRAs)
...
### 401(k) and 403(b) plans 401(k) 与 403(b) 计划
...
## 5. Testing Your Knowledge 5. 知识测试
...
1.  以下哪些属于累退税？
   ...
   (C) I, III, 和 IV
   (D) I, II, III, 和 IV
2. All of the following are types of tax-qualified retirement plans EXCEPT
   (A) 401(k)
   (B) profit-sharing
   (C) IRA
   (D) deferred compensation
2.  以下所有都是税务合格的退休计划类型，除了：
...
3. Which of the following are TRUE regarding Roth IRAs and Roth 401(k)s?
   (A) Withdrawals from both are tax-free provided that investors have held the accounts for at least five years and have reached the age of 59 1/2.
   (B) There are no contribution limits.
   (C) Contributions made to both are made pretax.
   (D) All of the above.
3.  关于 Roth IRA 和 Roth 401(k)，以下哪项是正确的？
   (A) 如果投资者持有账户至少五年且年满 59½ 岁，两者的提款都是免税的。
   (B) 没有缴款限额。
   (C) 两者的缴款都是税前的。
   (D) 以上所有。
4. An investor buys 1,000 shares of a stock at $30. If the stock increases in value to $50, how would the result be categorized?
   (A) Profit
   (B) Appreciation
   (C) Capital gain
   (D) Investment income
4.  一位投资者以 $30 买入 1,000 股股票。如果股票价值涨至 $50，该结果应如何分类？
   (A) 利润
   (B) 增值
   (C) 资本利得
   (D) 投资收入
5. According to the wash sale rule, if a customer sold a security at a loss, which of the following is TRUE?
   (A) The customer cannot purchase call options on the same security for 30 days before or after the sale and be able to claim the loss.
   (B) The customer cannot purchase bonds by the same issuer for 30 days before and after the sale and be able to claim the loss.
   (C) The customer cannot sell short the same security within 30 days before or after the sale and be able to claim the loss.
   (D) The customer cannot purchase mutual funds holding the same security for 30 days before or after the sale and be able to claim the loss.
5.  根据洗售规则，如果客户以亏损出售证券，以下哪项是正确的？
   (A) 客户无法在出售前或后 30 天内购买相同证券的看涨期权并主张亏损。
   (B) 客户无法在出售前或后 30 天内购买同一发行人发行的债券并主张亏损。
   (C) 客户无法在出售前或后 30 天内卖空相同证券并主张亏损。
   (D) 客户无法在出售前或后 30 天内购买持有相同证券的共同基金并主张亏损。
6. An individual investor who lives at home with their parents is covered by an employer pension plan. However, they would like more coverage at retirement and decides to put the maximum allowable contribution in an IRA. If their salary is $52,000 per year, which of the following is TRUE?
...
6.  一位与父母同住的个人投资者参加了雇主养老金计划。但是，他们希望在退休时获得更多保障，决定向 IRA 存入最大允许缴款。如果他们的年薪为 52,000 美元，以下哪项是正确的？
   (A) 向 IRA 的缴款可全额抵税。
   (B) 向 IRA 的缴款可部分抵税。
   (C) 向 IRA 的缴款不可抵税。
   (D) 无法确定。
7. Which of the following is taxable for an investor for the year in which it occurs?
   I. Stock dividends
   II. Cash dividends
...
7.  以下哪项对投资者在发生当年需要纳税？
   ...
   (C) II, III, 和 IV
   (D) I, II, III, 和 IV
8. A customer purchased 100 shares of ABC stock at $40 per share on March 24. On March 24 of the following year, the customer sold the stock at $46 per share. Which TWO of the following are TRUE regarding these transactions?
   ...
   IV. The gain would be taxed at 0 percent, 15 percent, or 20 percent, depending on the customer's adjusted gross income.
   (A) I and III
   (B) I and IV
   (C) II and III
   (D) II and IV
8.  客户于 3 月 24 日以每股 40 美元购买了 100 股 ABC 股票。客户于次年 3 月 24 日以每股 46 美元出售了该股票。关于这些交易，以下哪两项是正确的？
   I. 它们将被作为短期资本利得征税。
   II. 它们将被作为长期资本利得征税。
   III. 利得将按客户的税率档次征税。
   IV. 利得将根据客户的调整后总收入按 0%、15% 或 20% 征税。
   (A) I 和 III
   (B) I 和 IV
   (C) II 和 III
   (D) II 和 IV
9. Which of the following types of retirement plans is a salary reduction plan set up for public school employees?
   (A) SEP-IRAs
   (B) 401(k)
   (C) 403(b)
   (D) Profit-sharing
9.  以下哪种退休计划是为公立学校员工设立的减薪计划？

   (A) SEP-IRA
   (B) 401(k)
   (C) 403(b)
   (D) 利润分享计划
10. An investor can always contribute money to an IRA even if covered by an employer pension plan. However, whether it's deductible depends on the investor's earnings. For a single investor who makes up to $77,000, which of the following is TRUE?
    (A) The investor can contribute to an IRA and deduct the full amount.
    (B) The investor can contribute but cannot deduct anything.
    (C) The investor cannot contribute to an IRA at all.
    (D) The investor can contribute and deduct a portion.
10. 即使参加了雇主养老金计划，投资者也总是可以向 IRA 缴款。但是，是否可抵税取决于投资者的收入。对于收入在 77,000 美元以下的单身投资者，以下哪项是正确的？
    (A) 投资者可以向 IRA 缴款并全额抵税。
    (B) 投资者可以缴款但不能抵税。
    (C) 投资者根本不能向 IRA 缴款。
    (D) 投资者可以缴款并抵免部分金额。
...
1.  **C.** Sales, gasoline, and alcohol taxes are regressive (same rate for everyone). Income tax is progressive.
1.  **C.** 销售税、汽油税和酒精税都是累退税（税率相同）。所得税是累进税。
2.  **D.** Deferred compensation plans are nonqualified (not available to all employees, funded with after-tax dollars).
2.  **D.** 递延薪酬计划是不合格计划（并非所有员工都可参加，由税后资金资助）。
3.  **A.** Roth accounts offer tax-free withdrawals if held for 5 years and the investor is at least 59 1/2.
3.  **A.** 如果持有账户满 5 年且投资者年满 59½ 岁，Roth 账户提供免税提款。
4.  **B.** Until the stock is sold, the increase in value is called appreciation (unrealized gain). It only becomes a capital gain when sold.
4.  **B.** 在股票卖出之前，价值的增加称为增值（未实现收益）。只有卖出后才成为资本利得。
5.  **A.** Under the wash sale rule, you cannot buy the same security or anything convertible into it (like call options, warrants, or rights) within the 30-day window.
5.  **A.** 根据洗售规则，您不能在 30 天窗口期内购买相同证券或任何可转换为该证券的资产（如看涨期权、认股权证或认股权）。
6.  **B.** Contributions to the IRA are partially deductible for an investor covered by an employer pension plan with income between $77,000-$87,000.
6.  **B.** 对于参加了雇主养老金计划且收入在 77,000-87,000 美元之间的投资者，向 IRA 的缴款可部分抵税。
7.  **B.** Cash dividends, interest from corporate bonds are taxable. Interest from U.S. government bonds is taxable at the federal level but exempt from state and local taxes. Stock dividends are not taxable.
7.  **B.** 现金股息、公司债券利息需纳税。美国政府债券利息在联邦层面需纳税，但在州和地方层面免税。股票股息不需纳税。
8.  **D.** Since the stock was held for more than one year (March 24 to March 24 of the following year), this is a long-term capital gain, taxed at 0%, 15%, or 20% depending on income.
8.  **D.** 由于股票持有超过一年（从 3 月 24 日到次年 3 月 24 日），这是长期资本利得，根据收入按 0%、15% 或 20% 征税。
9.  **C.** 403(b) plans are salary reduction plans set up for public school employees and non-profit organizations.
9.  **C.** 403(b) 计划是为公立学校员工和非营利组织设立的减薪计划。
10. **A.** An investor who makes up to $77,000 can contribute to an IRA and deduct the full amount, even if covered by an employer pension plan.
10. **A.** 收入在 77,000 美元以下的投资者可以向 IRA 缴款并全额抵税，即使参加了雇主养老金计划也是如此。
