...
直接参与计划 （DPPs） 可以筹集资金投资于房地产、石油和天然气、设备租赁等领域。这些业务更常被称为**有限合伙企业 （limited partnerships）**，在某种程度上与公司（股东所有的公司）类似。然而，有限合伙企业具有许多其他投资所不具备的特定税务优势（和劣势）。根据税法，有限合伙企业**不被直接征税**；其收入或亏损会**直接穿透 （passed through）** 给投资者。

DPPs were once known as **tax shelters** because of the tax benefits to investors, but tax law changes have taken away a lot of these advantages. As a result, DPPs have somewhat fallen out of favor for investors (though not entirely for the SIE exam designers).
DPP 曾因其对投资者的税务优惠而被称为“**避税工具 （tax shelters）**”，但税法的变更已经取消了其中的许多优势。结果，DPP 在投资者中有些失宠（尽管在 SIE 考试出题者眼中并非如此）。

In this chapter, I explain the differences between limited and general partners, as well as the types of partnerships, their particular risks, and their potential rewards. The info here can help you examine those risks and rewards and determine the suitability of DPPs for investors. I also explain two inevitable facts of life as they apply to partnerships: the filing of paperwork and the payment of taxes. Finally, I explain the ins and outs and some of the specifics you need to know about **real-estate investment trusts (REITs)**. Unlike mutual funds that invest in a pool of securities, REITs invest in real estate. If you can't wait, they're discussed toward the end of the chapter. At the very end, I test your knowledge with a quick chapter quiz.
...
🧠 **REMEMBER**
The Internal Revenue Service (IRS) determines whether an enterprise is a corporation or a limited partnership. For a limited partnership to be considered (and taxed) as a limited partnership, it has to **avoid at least two** of the following corporate characteristics (usually, the last two):
🧠 **请记住**
美国国税局 （IRS） 决定一个企业是公司还是有限合伙企业。为了让有限合伙企业被视为有限合伙企业（并按此征税），它必须**避开以下至少两项**公司特征（通常是最后两项）：

*   **Having a centralized management：** Corporations have management in one place. The challenges of managing a limited partnership from several locations make this corporate trait quite difficult for a partnership to avoid. （具有集中管理：公司在同一个地方进行管理。从多个地点管理有限合伙企业的挑战使得合伙企业很难避开这一公司特性。）
*   **Providing limited liability：** Corporate shareholders have limited liability； well， so do limited partners. The liability of corporate shareholders is limited to the amount invested， and the liability of limited partners is limited to the amount invested plus a portion of any recourse loans taken out by the partnership （if any）。 Therefore， investors of a limited partnership would have limited liability unless a limited partner takes on an active role in the management decisions. If a limited partner takes on an active role in management， they could be considered a general partner and have unlimited liability. （提供有限责任：公司股东拥有有限责任；有限合伙人也是如此。公司股东的责任仅限于投资金额，有限合伙人的责任仅限于投资金额加上合伙企业所借任何追索权贷款的一部分（如果有）。因此，有限合伙企业的投资者将拥有有限责任，除非有限合伙人在管理决策中发挥主动作用。如果有限合伙人在管理中发挥主动作用，他们可能被视为普通合伙人并承担无限责任。）
*   **Having perpetual （never-ending） life：** Unlike corporations， which hope to last forever， limited partnerships are set up for a **defined period of time**。 Limited partnerships are dissolved at a predetermined time， such as when their goals are met or after a set number of years. （永续经营：与希望永存的公司不同，有限合伙企业是为**固定的一段时间**设立的。有限合伙企业在预定时间解散，例如当其目标实现或在设定的年限之后。）
*   **Having free transferability of partnership interest：** DPPs are difficult to get into and out of. Unlike shares of stock， which can be freely bought and sold by anyone， limited partners not only have to pass the scrutiny of a registered rep， but also require the **approval of the general partner**。 DPP investors （limited partners） must show that they have enough money to invest initially and have liquidity in other investments in the event that the partnership needs a loan. （具有合伙权益的自由转让性：DPP 很难进入和退出。与任何人都可以自由买卖的股票不同，有限合伙人不仅必须经过登记代表的审查，还需要得到**普通合伙人的批准**。DPP 投资者（有限合伙人）必须证明他们最初有足够的资金进行投资，并且在合伙企业需要贷款时在其他投资中拥有流动性。）

🧠 **REMEMBER**
For SIE exam purposes, you need to remember that the easiest corporate characteristics for a partnership to avoid are **perpetual life (continuity of life)** and **free transferability of shares**; the most difficult to avoid are providing limited liability and having a centralized management.
🧠 **请记住**
出于 SIE 考试的目的，您需要记住：合伙企业最容易避开的公司特征是**永续经营（经营连续性）**和**股份的自由转让性**；最难避开的是提供有限责任和具有集中管理。
...
| **Liability and litigation （责任与诉讼）** | Have **unlimited liability** （can be sued and held personally liable for all partnership debts and losses）。 （承担**无限责任**（可以被起诉，并对所有合伙债务和亏损承担个人责任）。） | Have **limited liability** （limited to the amount invested and a proportionate share of any recourse loans taken out by the partnership）； can inspect all the partnership books； can sue the general partner or can sue to dissolve the partnership. （承担**有限责任**（仅限于投资金额及在合伙企业所借追索权贷款中所占的比例）；可以检查所有合伙账簿；可以起诉普通合伙人或起诉解散合伙企业。） |
| **Financial involvement （财务参与）** | Maintain a financial interest in the partnership. （在合伙企业中维持财务利益。） | Provide money contributed to the partnership， recourse debt of the partnership， and nonrecourse debt for real-estate DPPs. （提供出资、合伙企业的追索权债务，以及房地产 DPP 的非追索权债务。） |
| **Financial rewards （财务回报）** | Receive compensation for managing the partnership. （因管理合伙企业而获得报酬。） | Receive their proportion of profits and losses. （按比例获得利润和分担亏损。） |
| **Conflicts of interest （利益冲突）** | Can't borrow money from the partnership； can't compete against the partnership （can't manage two buildings for two different partnerships in close proximity， for example）。 （不能从合伙企业借钱；不能与合伙企业竞争（例如，不能为两个不同的合伙企业管理相邻的两栋建筑）。） | None； can invest in competing partnerships. （无；可以投资于有竞争关系的合伙企业。） |

Partnerships are usually set up as **tenants in common (TIC)**. Each limited partner owns an undivided interest in the property held by the partnership. In addition, in the event that one of the limited partners dies, their partnership interest will be passed to a beneficiary or to their estate.
合伙企业通常设立为**按份共有 （TIC）**。每位有限合伙人对合伙企业持有的财产拥有未分割的权益。此外，如果其中一位有限合伙人去世，其合伙权益将传递给受益人或其遗产。
...
*   Charge a management fee for making decisions for the partnership （为合伙企业做决策而收取管理费）
...
*   How the profits are to be distributed （利润如何分配）
*   The roles of the participants （参与者的角色）
*   How the partnership can be dissolved （合伙企业如何解散）
*   Whether a limited partner can sell or assign their interest in the partnership （有限合伙人是否可以出售或转让其合伙权益）
...
One of your jobs as a registered rep is to **prescreen** the potential limited partner to make sure that the partnership is a good fit for that person. Consider the following questions:
作为一名注册代表，您的职责之一是对潜在有限合伙人进行**预先筛选**，以确保该合伙企业适合该人。请考虑以下问题：

*   Does the investor have enough money to invest （net worth and annual income）？ （投资者是否有足够的资金进行投资（净资产和年收入）？）
*   Does the investor have enough cash or liquidity in other investments in case the partnership needs more money？ （如果合伙企业需要更多资金，投资者是否有足够的现金或在其他投资中拥有流动性？）
*   Is the potential partner okay with tying up money for a long period of time？ （潜在合伙人是否愿意长期占用资金？）
*   Can they handle the risks？ （他们能否承担风险？）

Also, you need to review the agreement to ensure (to the best of your ability) that the information the investor provides is complete and accurate. Besides the investor's payment, the subscription agreement has to include items such as the investor's net worth and annual income, a statement explaining the risks of investing in the partnership, and a **power of attorney** that allows the general partner to make partnership investment decisions for the limited partner. The subscription agreement is typically sent in with some form of payment from the potential limited partner.
此外，您还需要审查协议，以（尽您所能）确保投资者提供的信息完整且准确。除了投资者的付款外，认购协议还必须包括投资者的净资产和年收入、解释投资合伙企业风险的声明，以及一份允许普通合伙人代表有限合伙人做出合伙投资决策的**授权书**。认购协议通常随潜在有限合伙人的某种形式的付款一起寄出。
...
🧠 **REMEMBER**
The key thing to remember for SIE purposes is that investors can write off passive losses **only against passive income** from other DPP investments.
🧠 **请记住**
...
*   **The economic soundness of the program.** In other words， do you think it will be profitable？ （计划的经济稳健性。换句话说，您认为它会盈利吗？）
*   **The expertise （track record） of the general partner.** （普通合伙人的专业知识（往绩记录）。）
*   **The basic objectives of the program.** （计划的基本目标。）
*   **The start-up costs involved.** （涉及的启动成本。）
...
*   **Public housing (government-assisted housing programs):** This type of real-estate DPP develops low-income and retirement housing. The focus of this type of DPP is to earn consistent income and receive tax credits. The U.S. government (through subsidies), via the U.S. Department of Housing and Urban Development (HUD), makes up any deficient rent payments. Appreciation potential is low, and maintenance costs can be high, but the DPP does benefit from some level of government security. Public-housing DPPs are backed by the U.S. government and, therefore, are typically considered to be the **safest real-estate DPPs**.
*   **公共住房（政府资助住房项目）：** 这种类型的房地产 DPP 开发低收入住房和养老住房。这类 DPP 的重点是赚取稳定的收入并获得税收抵免。美国政府（通过补贴）经由美国住房和城市发展部 （HUD） 补足任何租金缺口。升值潜力较低，且维护成本可能较高，但该 DPP 确实受益于一定程度看政府安全保障。公共住房 DPP 由美国政府支持，因此通常被认为是**最安全的房地产 DPP**。
*   **Existing properties:** This type of DPP purchases existing properties with the intent of generating a regular stream of rental income. Because the properties already exist, this DPP generates immediate cash flow. The risks with this type of DPP are that the maintenance or repair expenses will eat into the profit and that tenants won't renew their leases. The properties already exist and are producing income, so risk for this type of DPP is relatively low.
*   **现有物业：** 这种类型的 DPP 购买现有物业，目的是产生稳定的租金收入流。因为物业已经存在，这种 DPP 会产生即时现金流。这类 DPP 的风险在于维护或维修费用会削减利润，以及租户可能不续租。物业已经存在并正在产生收入，因此这类 DPP 的风险相对较低。
*   **New construction:** This type of DPP purchases property for the purpose of building. After completing the construction, the partnership's goal is to sell the property and structure at a profit after all expenses. Building costs may be more than expected, and the partnership doesn't receive income until the property is sold, but the DPP can benefit from appreciation on both the land and the structure. Although this investment is **speculative (risky)**, it's not as risky as a raw-land DPP.
*   **新建筑：** 这种类型的 DPP 以建筑为目的购买土地。在完成建设后，合伙企业的目标是在扣除所有费用后以盈利的价格出售土地和建筑。建筑成本可能超过预期，且合伙企业在物业售出前不会收到收入，但该 DPP 可以从土地和建筑的增值中获益。虽然这种投资具有**投机性（高风险）**，但不如荒地 DPP 风险大。
*   **Raw land:** This type of DPP invests in undeveloped land in anticipation of long-term capital appreciation, which means raw-land DPPs don't actually build on or rent out the property. The partnership hopes that the property purchased will appreciate in value so that the DPP can sell the property for more than the purchase price plus all expenses.
*   **荒地：** 这种类型的 DPP 投资于未开发的土地，以期待长期的资本增值，这意味着荒地 DPP 实际上并不在土地上建造建筑或出租物业。合伙企业希望所购土地能够升值，以便 DPP 能以高于购买价格加所有费用的价格将其售出。

🧠 **REMEMBER**
Raw-land DPPs are considered to be the **riskiest real-estate DPPs** because the partnership doesn't have any cash flow (no rental or sales income) and the value of the land may not increase; it may actually decrease.
🧠 **请记住**
荒地 DPP 被认为是**风险最高的房地产 DPP**，因为合伙企业没有任何现金流（没有租金或销售收入），而且土地价值可能不会增加，甚至可能减少。

💡 **TIP**
The main thing to remember with real-estate DPPs is that depending on which type you invest in, they can provide capital growth potential through the appreciation of property held by the DPP; cash flow for DPPs that hold rentals; tax deductions for mortgage interest, depreciation, and capital improvements; and tax credits for DPPs that hold government-assisted housing.
💡 **提示**
...
*   **Operating lease:** This type of equipment leasing program purchases equipment and leases it for a short period of time. The DPP doesn't receive the full value of the equipment during the first lease. This type of arrangement allows the DPP to lease the equipment several times during the life of the machinery.
*   **营运租赁 （Operating lease）：** 这种类型的设备租赁项目购买设备并进行短期租赁。DPP 在第一次租赁期间不会收回设备的全部价值。这种安排允许 DPP 在机器的整个寿命期内多次租赁该设备。
...
*   **全额赔付租赁 （Full payout lease）：** 这种类型的设备租赁项目购买设备并进行长期租赁。DPP 从第一次租赁中获得足够的收入来支付设备成本和任何融资成本。通常，初始租赁期会持续到设备的整个使用寿命。
...
*   **Intangible drilling costs (IDCs):** IDCs are write-offs for drilling expenses. The word *intangible* is your clue that you're not talking about actual equipment. These costs include wages for employees, fuel, repairs, hauling of equipment, insurance, and so on. IDCs are usually completely deductible in the tax year in which the intangible costs occur. IDC deductions are only for drilling and preparing a well for the production of oil and gas.
*   **无形钻探成本 （IDCs）：** IDCs 是针对钻探费用的税收抵扣。“无形”这个词是您的线索，说明指的不是实际的设备。这些成本包括员工工资、燃料、维修、设备搬运、保险等。IDCs 通常在发生无形费用的纳税年度内可以完全抵扣。IDC 抵扣仅适用于钻探和为生产油气而准备油井的过程。
*   **Tangible drilling costs (TDCs):** TDCs are write-offs on items purchased that have salvage value (items that can be resold). All oil and gas DPPs have TDCs, which include costs for purchasing items such as storage tanks and well equipment. These costs aren't written off immediately but are depreciated (deducted) over several years. Depreciation may be claimed on either a straight-line basis (writing off an equal amount each year) or an accelerated basis (writing off more in the early years and less in the later years).
*   **有形钻探成本 （TDCs）：** TDCs 是针对具有残值（可转售物品）的采购项目的税收抵扣。所有油气 DPP 都有 TDCs，包括购买储罐和井口设备等物品的成本。这些成本不会立即抵扣，而是在几年内进行折旧（减扣）。折旧可以按直线法（每年抵扣相同的金额）或加速折旧法（早期抵扣较多，后期较少）进行申报。

🧠 **REMEMBER**
IDCs are fully deductible in the current year; TDCs are depreciated (deductible) over several years.
🧠 **请记住**
IDCs 在当年完全可以抵扣；TDCs 则在几年内进行折旧（抵扣）。
...
*   **折耗 （Depletion）：** 折耗是一种税收抵扣，允许经营自然资源（如石油和天然气）的合伙企业因资源供应量减少而进行抵扣。合伙企业只能对已售出的自然资源量申请折耗抵扣（未提取或存放在仓库待售的资源不在此列）。

🧠 **REMEMBER**
Depletion deductions are only for DPPs that deal with natural resources. On the SIE exam, the only DPP with depletion deductions that you need to be concerned about is oil and gas.
🧠 **请记住**
折耗抵扣仅适用于经营自然资源的 DPP。在 SIE 考试中，您唯一需要关注的具有折耗抵扣的 DPP 是石油和天然气。
...
| **Income （收入型）** | To provide immediate income by purchasing producing wells. （通过购买正在产油的油井来提供即时收入。） | The partnership generates immediate cash flow； the least risky of the oil and gas DPPs； no IDCs. （合伙企业产生即时现金流；油气 DPP 中风险最小的；没有 IDCs。） | High initial costs； the well could dry up； gas prices could go down. （初始成本高；油井可能枯竭；天然气价格可能下跌。） |
| **Combination （组合型）** | To provide income to help pay for the cost of finding new oil reserves. （提供收入以帮助支付寻找新油气储量的成本。） | The ability to offset the costs of drilling new wells by using income generated by existing wells. （能够利用现有油井产生的收入来抵销钻探新井的成本。） | Carries the risks of all the programs combined. （承担所有项目结合在一起的风险。） |

📝 **EXAMPLE**
The following question concerns different DPP investments.
Ayla has money invested in a limited partnership that's expected to have a significant amount of income over the next one to two years. Which of the following programs would BEST help Ayla shelter the MOST of that income?
(A) Oil and gas exploratory (B) Raw land purchasing (C) Equipment leasing (D) Existing real-estate property
The answer you want is (A). Oil and gas exploratory programs spend a lot of money attempting to find and drill for oil. These programs have high IDCs, which are fully tax-deductible when the drilling occurs. Therefore, the oil and gas exploratory programs have the largest write-offs in the early years, which could help Ayla offset some or all of their passive income from the other limited partnership.

📝 **案例**
以下问题涉及不同的 DPP 投资。
Ayla 在一个有限合伙企业中投资了资金，预计在未来一到两年内将产生大量收入。以下哪种项目能最有效地帮助 Ayla 规避掉这部分收入的大部分税收？
（A） 石油和天然气勘探型 （B） 荒地购买 （C） 设备租赁 （D） 现有房地产物业
您想要的答案是 （A）。石油和天然气勘探型项目在尝试寻找和钻探石油方面投入巨大。这些项目具有高额的 IDCs，在钻探发生时可以完全抵税。因此，石油和天然气勘探型项目在早期拥有最大的税收冲销额，这可以帮助 Ayla 抵销来自其他有限合伙企业的部分或全部被动收入。

🧠 **REMEMBER**
Unlike corporations, DPPs have an ending date. That date could be predetermined as placed in the partnership agreement, when a project is completed (such as when buildings are built and sold, oil is found and the land is sold, equipment is sold, and so on), or when the limited partners vote to dissolve the partnership. When the partnership is dissolved, the first to be paid out of the partnership assets are **secured creditors**; then **general creditors** are paid; next, **limited partners** are paid; and the last to be paid are the **general partners**.
🧠 **请记住**
...
Types of REITs include the following:

*   **Equity REITs** take equity positions in real-estate properties； the income is derived from rent collected or profits made when the properties are sold. Equity REITs typically hold income-producing properties like apartments， shopping malls， vacation resorts， and so on. （权益型 REITs 持有房地产物业的股权；收入来源于收取的租金或出售物业所获得的利润。权益型 REITs 通常持有能产生收入的物业，如公寓、购物中心、度假胜地等。）
*   **Mortgage REITs** purchase construction loans and mortgages. The trust receives the interest paid on the loans and in turn passes it on to the owners of the trust （the investors）。 （抵押型 REITs 购买建筑贷款和抵押权。信托收取贷款利息，并将其传递给信托的所有者（投资者）。）
*   **Hybrid REITs** are a combination of equity and mortgage REITs. Hybrid REITs generate income derived from rent and capital gains （like equity REITs） and interest （like mortgage REITs）。 （混合型 REITs 是权益型和抵押型 REITs 的结合。混合型 REITs 的收入来源于租金和资本利得（类似权益型）以及利息（类似抵押型）。）

As for taxation, REITs can avoid being taxed like a corporation if:

*   At least 75 percent of the income comes from activities related to real-estate. （至少 75% 的收入来自与房地产相关的活动。）
*   At least 75 percent of the REIT's assets are in real estate， government securities， and/or cash. （至少 75% 的 REIT 资产是房地产、政府证券和/或现金。）
*   At least 90 percent of the net income received is distributed to shareholders （who pay taxes on the income）。 （至少 90% 的净收入被分配给股东（由股东对该收入纳税）。）

Which means that, unlike corporations that are taxed at the corporate level and investors who are taxed on the cash dividends, there's **no double taxation** with REITs if they follow these rules. So, for individuals investing in REITs, they have tax-advantaged income.

⚠️ **WARNING**
Don't get REITs confused with real-estate limited partnerships. Limited partnerships, such as RELPs, **pass on (the industry term is *pass through*) income and losses** to investors to claim on their own personal tax return; **REITs only pass income and gains** through to investors, **not losses** or write-offs.
⚠️ **警告**
不要将 REIT 与房地产有限合伙混淆。有限合伙（如 RELP）将**收入和亏损穿透 （pass through）** 给投资者，由投资者在个人税单上申报；而 **REIT 仅将收入和收益**传递给投资者，**不传递亏损**或冲销额。
...
1. Which of the following is NOT TRUE of real-estate investment trusts?
   (A) They may trade at a discount to the NAV.
...
3.  **A.** Passive income is income received from a limited partnership. Passive income can be written off against passive losses but not capital losses.
4.  **A.** Exploratory programs are the riskiest because the partnership is drilling in unproven areas trying to find oil. As with other investments, typically, the more risk investors take, the more potential reward. For this type of program, the risks are greatest, but if the partnership finds oil, the rewards should be much higher than those of other oil and gas programs.
5.  **D.** To officially accept a new limited partner to the partnership, a general partner must sign the subscription agreement.
6.  **B.** For a partnership to not be taxed as a corporation, it must avoid at least two corporate characteristics. The easiest corporate characteristics for a partnership to avoid are having a perpetual life (partnerships are set up for a finite period of time) and having free transferability to partnership interest. Because of the approval process, limited partnerships are some of the most difficult investments to get into and out of.
7.  **D.** All the choices listed are benefits of investing in a limited partnership. Investors are certainly getting (or hoping for) professional management by way of a general partner. Also, because a partnership isn't taxed as a corporation, the gains and losses are passed through to investors. In addition, limited partners' losses are limited to the amount invested plus any recourse loans (for real-estate DPPs only).
