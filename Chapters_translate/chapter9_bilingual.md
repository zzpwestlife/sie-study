# Part 3: Packaged Securities and Managed Money 第 3 部分：组合证券与受托理财
...
# Chapter 9: Delivering Diversification with Packaged Securities 第 9 章：通过组合证券实现多样化
...
当您帮助客户建立证券投资组合时，多样化是关键，而当您的客户有大量资金可供投资时，这相当容易。但如果投资者的资源有限呢？当然，这类投资者负担不起购买多家公司的数百股股票和/或债务证券，而您也不想将客户限制在仅有的一个投资机会上（天知道它会不会倒闭）。组合证券（包装证券）来救场了！这些证券，如开放式基金、封闭式基金、面值证单公司、单位投资信托和年金，通过将客户的资金投资于一个多样化的证券池，在单一证券内提供多样性——当然，这是有成本的。这种以营利为目的的团队协作可以确保您客户的投资比（打个比方）在拉斯维加斯赌场里玩老虎机要安全得多。
...
*   Whether the company plans to raise money by borrowing （公司是否计划通过借款筹集资金）
*   Whether they plan on investing in commodities or real estate （是否计划投资于大宗商品或房地产）
*   How they plan on investing （a single industry， many industries， debt securities， and so on） （计划如何投资（单一行业、多个行业、债务证券等））
*   Conditions under which the investment plan can change （a vote of shareholders， for example） （投资计划变更的条件（例如股东投票））
*   The business experience of each director and officer （每位董事和高级职员的业务经验）

---


## 2. Diversifying through Management Investment Companies 2. 通过管理型投资公司实现多样化
...
通常，投资公司是以投资证券为业务的公司。因此，它们将从投资者那里收到的资金投资于大量不同的证券。每位投资者根据其在投资公司的权益分享利润或分担损失。1940 年《投资公司法》将投资公司分为三大类：**管理型投资公司**、**面额证书公司**和**单位投资信托**。本节重点讨论管理型投资公司，这是本章考查较多的领域。我将在随后名为“考虑其他投资公司选项”的部分介绍其他类型。
...
管理型公司是迄今为止最广为人知的投资公司类型。管理型公司持有的证券往往由投资组合经理进行主动管理，但也可能是被动的——即经理做出初始选择但不进行活跃交易。作为管理型公司的细分，它们分为**多样化**或**非多样化**。要达到多样化标准，公司必须按以下方式分散其至少 75% 的资产：

*   The management company can't own more than 10 percent of the outstanding shares of a company. （管理型公司持有的某公司流通股比例不得超过 10%。）
*   No more than 5 percent of the management company's money can be invested in one company's securities. However， through appreciation， one company may grow to more than 5 percent， which is fine， but the fund may not purchase any more of that company's securities unless it drops below 5 percent. （投资于任何一家公司的资金比例不得超过管理型公司总资产的 5%。然而，如果由于资产增值，某家公司的比例增长超过了 5%，这是允许的，但除非该比例降至 5% 以下，否则基金不得再购买该公司的证券。）
...
🧠 **请记住**
由于多样化部分仅涉及管理型公司资产的 75%，其余 25% 可以以任何方式进行投资。管理型公司是属于多样化还是非多样化，必须在招股说明书中说明。

---


## 3. Comparing open- and closed-end funds 3. 比较开放式和封闭式基金
...
### Open-end (mutual) funds 开放式（共同）基金

An open-end fund is more commonly known as a **mutual fund**. Like closed-end funds, mutual funds invest in many different securities to provide diversification for investors. The key difference is that mutual funds are constantly issuing and redeeming shares (shares are redeemed with the issuer and not sold in the market), which provides liquidity for investors. Because open-end fund shares are continuous offerings of new shares, a mutual fund prospectus must always be available. You need to understand the makings of the net asset value and the public offering price when taking the SIE exam:
开放式基金通常被称为**共同基金**。与封闭式基金一样，共同基金投资于多种不同的证券，为投资者提供多样化选择。关键区别在于，共同基金在不断发行和赎回股份（股份向发行人赎回，不在市场上出售），这为投资者提供了流动性。由于开放式基金股份属于新股的持续发行，因此必须始终备有共同基金招股说明书。在参加 SIE 考试时，您需要了解资产净值和公开发售价的构成：
...
*   **资产净值 （NAV）：** 幸运的是，开放式和封闭式基金的 NAV（即每股资产净值）的确定方法是相同的：将基金持有的证券价值除以流通股数。然而，对于开放式基金，NAV 是**买入价 （bid price）**。当投资者赎回共同基金股份时，他们收到的是下一次计算出的 NAV（通常是在当天收盘时）。这也被称为**赎回价值**。共同基金的交易价格绝不会低于 NAV。
...
*   **公开发售价 （POP）：** 对于共同基金，公开发售价（即**卖出价/发售价 ask price**）是 NAV 加上销售费用。如果共同基金不收取销售费用，则被称为**无销售费基金 （no-load fund）**。
...
基金必须持续在其招股说明书年度报告中包含将基金表现与适当指数（标准普尔 500、纳斯达克综合指数等）进行对比的图表、过去一年可能影响表现的项目和/或策略，以及基金经理的姓名。
...
与开放式基金不同，封闭式基金的流通**股份数量是固定的**（因此得名“封闭”）。封闭式基金比开放式基金更像普通股，因为它们向公众发行新股；之后，这些股份在市场上买卖。由于它们在市场上交易，它们通常被称为**上市交易基金**。虽然封闭式和开放式基金的资产净值计算方法相同，但公开发售价的确定方式略有不同：

*   **NAV:** The NAV or net asset value per share is the parity price at which the fund should be trading. You determine it by taking all of the assets owned by the fund, subtracting the liabilities, and dividing by the number of shares outstanding. Closed-end funds may trade at a **discount or premium** compared to the NAV — based on supply and demand.
*   **NAV：** NAV（即每股资产净值）是基金应该交易的等价价格。您通过取基金拥有的所有资产，减去负债，再除以流通股数来确定它。封闭式基金的交易价格可能比 NAV 存在**折价或溢价**——这取决于供求关系。
...
*   **公开发售价 （POP）：** 对于封闭式基金，在首次公开募股 （IPO） 之后，公开发售价（卖出价）不仅取决于 NAV，还取决于该发行的供求关系。封闭式基金的投资者在代理交易中支付 POP（当前市场价格）加上经纪商佣金。
...
注：虽然封闭式基金不是从发行人处购买或向其赎回的，但基于其股份数量，大多数基金提供了高度的流动性。在首次发行后，它们可以在交易所（称为交易所交易基金或 ETFs）或场外交易市场 （OTC） 购买或出售。

---


## 4. Open and closed: Focusing on their differences 4. 开放与封闭：聚焦差异
...
| :--- | :--- | :--- |
| **Capitalization （资本化/募集方式）** | One-time offering of securities （fixed number of shares outstanding）。 （证券的一次性发行（流通股数固定）。） | Continuous offering of new shares （no fixed number of shares outstanding）。 （新股的持续发行（流通股数不固定）。） |
| **Pricing the fund （基金定价）** | Investors purchase at the current market value （POP） plus a commission. （投资者按当前市场价值 （POP） 加上佣金购买。） | Investors purchase at the NAV plus a sales charge. （投资者按 NAV 加上销售费用购买。） |
| **Issues （证券品种）** | Common stock， preferred stock， and debt securities. （普通股、优先股和债务证券。） | Common stock only. （仅限普通股。） |
| **Shares purchased （股份购买）** | Shares can be purchased in full only. （股份仅能整股购买。） | Shares can be purchased in full or fractions （up to three decimal places）。 （股份可以整股或零碎购买（精确到小数点后三位）。） |
| **Purchased and sold （买卖方式）** | Initial public offerings （IPOs） go through underwriters； after that， investors purchase and sell shares either over-the-counter or on an exchange （no redemption）。 （首次公开募股 （IPOs） 通过承销商进行；之后，投资者在场外或交易所买卖股份（不可赎回）。） | Shares are sold and redeemed by the fund only. （股份仅由基金销售和赎回。） |
...
## 5. Keeping your customer's investment objectives in mind 5. 牢记客户的投资目标
...
与面额证书公司和单位投资信托的投资者不同（见本章后面的“考虑其他投资公司选项”），开放式和封闭式基金的投资者有很多选择。投资者可能在寻求安全性、增长性或两者的结合等。本节将为您展示这些投资选择。
...
🧠 **请记住**
对于投资组合证券的客户来说，最重要的一项考量就是**基金的投资目标**。这一特征甚至超过了销售费用或管理费。如果您成为一名注册代表，您的主要职责之一就是帮助投资者决定哪种类型的基金最适合他们。出题者想知道您是否能胜任这项工作。
...
比较同类型的基金是次要的。因此，废话少说，以下是主要的基金类型（虽然每个基金内部的变量可能使基金风险更高或更低，但我按照从最安全到最危险的常规顺序排列了该列表）：
...
*   **货币市场基金：** 正如您可能已经猜到的，这种基金投资于货币市场工具（短期债务证券）。与其他类型的基金相比，您需要更深入地了解这种基金的细节。以下是关键点：
    *   It usually provides a check-writing feature （you're given a checkbook） as a way of redeeming shares. （通常提供支票开具功能（会给您一本支票簿）作为赎回股份的一种方式。）
    *   It's always **no-load** （there's no sales charge）。 （始终是**无销售费 （no-load）** 的（没有申购费）。）
    *   It computes dividends daily and credits them monthly. （每日计算股息，每月计入账户。）
    *   There's no penalty for early redemption. （提前赎回没有罚款。）
...
*   **收益型基金 （Income fund）：** 收益型基金的首要目标是为投资者提供当期收入（而非增长）。这类基金将其大部分资产投资于多样化的组合，包括：（a） 支付利息的债务证券，以及 （b） 以持续支付现金股息闻名的公司的优先股和普通股。
...
🧠 **请记住**
收益型基金被认为比增长型基金安全得多（更保守）。就 SIE 考试（以及现实生活）而言，您可以假设收益型基金是退休人员和寻求稳定现金流且不愿承担太多风险的投资者的更好选择。
...
*   **平衡型基金 （Balanced fund）：** 平衡型基金是增长型基金和收益型基金的结合。平衡型基金投资于普通股、优先股、长期债券和短期债券，旨在最大限度降低风险的同时，提供收入和资本增值。这些基金在熊市时不会遭受太惨重的打击，但在牛市时通常表现不如大盘。
...
*   **增长型基金 （Growth fund）：** 这种基金正如您所预料的那样——增长型基金将其大部分资产投资于相对较新或现有公司的普通股多样化组合，追求股价的大幅上涨。增长型基金提供更高的增长潜力，但通常伴随着投资者的更高风险。这类基金非常适合寻求长期资本增值潜力的投资者。

🧠 **REMEMBER**
Because of the inherent risk of investing in growth funds, they're better for younger investors who can take the risk because they have more time to recover their losses. Some growth funds are labeled as **aggressive growth funds** because the securities it invests in are even riskier than those of a standard growth fund.
🧠 **请记住**
由于投资增长型基金存在固有风险，它们更适合能够承担风险的年轻投资者，因为他们有更多时间来弥补亏损。一些增长型基金被标记为**激进增长型基金 （aggressive growth funds）**，因为它们投资的证券比标准增长型基金风险更高。
...
*   **专业化（行业）基金：** 专业化或行业基金主要投资于单一行业的证券。专业基金可能仅投资于金融服务、医疗保健、汽车股、科技证券等。由于专业基金在投资方面受到限制，您可以假设在许多情况下，它们比一般基金风险稍大（波动性更强）。
...
*   **国际或全球基金：****国际基金**投资于投资者本国**以外**任何地方的公司。**全球基金**投资于**世界各地**（包括投资者本国）的证券。虽然国际和全球基金有助于完善投资组合，但它们并非没有风险。除了投资一般证券所面临的风险外，国际和全球基金的持有者还面临**汇率风险 （currency risk）**，即美国与外国发行人之间的货币汇率变动可能损害投资者利益。此外，特定国家的政治局势也可能损害基金价值。
...
💡 **提示**
不要让基金的多样性分散您太多的精力。市面上有这么多不同的基金，选择起来可能会让您抓狂。我列出了主要类型，但基金可以按目标（如前所述）或构成进行投资，例如外国股票基金（投资于外国证券）、免税基金（投资于市政债券）、美国政府基金等。基金的构成应能帮助您将其与客户的目标相匹配。追求安全和收入的客户可能会投资美国政府债券基金。

---


## 6. Dealing with discounts 6. 处理折扣
...
基金有投资顾问（投资组合经理），他们按基金持有的证券价值的一定百分比获取报酬。因此，诱使投资者投入更多资金的一种方法是，当他们投入一定的最低金额时，降低销售费用。这就是**折让点 （breakpoint）** 的用武之地。
...
投资者签署的**意向书 （LOI）** 允许他们在初始购买时立即获得折让点（数量折扣），即使投资者尚未存入足够的资金来达到折让点。该文件规定，只要投资者在 **13 个月**内投入足够的资金，他们就可以立即享受折扣后的销售费。

Here are a few specifics about the letter of intent that you need to know for the SIE:
以下是参加 SIE 考试需要了解的有关意向书的几点细节：

*   The investor has **13 months** after the first deposit to live up to the terms of the letter of intent in order to maintain the reduced sales charge. （投资者在第一次存款后的 13 个月内必须履行意向书条款，以维持减免的销售费。）
*   The LOI may be **backdated for up to 90 days**， meaning that it may apply to a previous purchase. However， remember that if the LOI applies to a previous purchase， the 13-month period starts from the date of that previous transaction. （意向书可以**回溯长达 90 天**，这意味着它可能适用于之前的购买。但是请记住，如果意向书适用于之前的购买，则 13 个月的期限从该次交易日期开始计算。）
*   While the investor is under the letter of intent， shares are held in **escrow** to pay for the difference in the sales charge. If the investor doesn't live up to the terms of the obligation， the fund sells the shares held in escrow. （在意向书期间，股份被存放在**代管账户**中，用于支付销售费用的差额。如果投资者未能履行义务条款，基金将出售代管的股份。）

🧠 **REMEMBER**
Investors may redeem their shares at any time, even if they're under a LOI.
🧠 **请记住**
投资者可以随时赎回其股份，即使他们签署了意向书。

---


## 7. Figuring the sales charge and public offering price of open-end funds 7. 计算开放式基金的销售费用和公开发售价
...
(A) 3.4 percent (B) 3.75 percent (C) 4 percent (D) 4.35 percent
...
sales charge = (POP – NAV) / POP = ($10.00 – $9.60) / $10.00 = $0.40 / $10.00 = 4%

📝 **案例**
ABC 激进增长型基金的资产净值为 9.60 美元，公开发售价为 10.00 美元。销售费用百分比是多少？

(A) 3.4% (B) 3.75% (C) 4% (D) 4.35%
正确答案是 （C）。您首先要做的就是建立等式。从 POP 10.00 美元开始，减去 NAV 9.60 美元，得到 0.40 美元。接下来，用 0.40 美元除以 POP 10.00 美元，得到 4% 的销售费：
销售费用 = （POP – NAV） / POP = （$10.00 – $9.60） / $10.00 = $0.40 / $10.00 = 4%
...
### Public offering price (POP) 公开发售价 （POP）

🧠 **REMEMBER**
When taking the SIE exam, you may be asked to figure out the POP of a mutual fund when you're given only the sales charge percent and the NAV. The sales charge is already part of the POP, so the sales charge is not equal to the sales charge percent times the NAV. Use the following formula to figure out how much an investor has to pay to buy shares of the fund when you know only the NAV and the sales charge percentage:
**public offering price = net asset value / (100% – sales charge %)**
🧠 **请记住**
在参加 SIE 考试时，您可能会被要求在仅给出销售费用百分比和 NAV 的情况下计算共同基金的 POP。由于销售费用已经是 POP 的一部分，因此销售费用不等于销售费用百分比乘以 NAV。当您只知道 NAV 和销售费用百分比时，请使用以下公式计算投资者购买基金股份必须支付的金额：
**公开发售价 = 资产净值 / （100% – 销售费用 %）**

---


## 8. Classifying the load 8. 费用类别的分类
...
正如我在本章前面所解释的，大多数共同基金都会收取包含在 POP 中的销售费用（也称为 **load**）。大多数在购买时预先收取，但有些会持续收取；有些在赎回时收取；还有些根本不收费用。根据投资者的付费方式，共同基金分为以下几个类别：
...
*   **A 类股（前端收费）：** 投资者在购买基金股份时支付费用。这类基金通常更适合长期投资者，因为它们通常拥有较低的费用率，且对大额购买有折让点。
...
*   **B 类股（后端收费）：** 投资者在赎回基金股份时支付费用。这类基金的费用率高于 A 类股，但如果持有多年，通常会转换为 A 类股。目前很少有共同基金公司提供 B 类股。
...
*   **C 类股（级别收费 / 年度收费）：** 投资者在持有基金期间定期（通常是每年）支付费用。这些基金的费用率高于 A 类股，并设有退出费（通常持有一两年后取消）。这些基金通常是短期投资者的最佳选择。
...
*   **无销售费 （No-load）：** 投资者不支付销售费用，但可能被收取某种交易费。与收费共同基金不同，无销售费基金收取的 12b-1 费用不得超过 **25 个基点**。

---


## 9. Considering Other Investment Company Options 9. 考虑其他投资公司选项
...
### Face-amount certificate companies 面值证单公司
...
### Unit investment trusts 单位投资信托 （UITs）
...
**单位投资信托 （UIT）** 是一家注册投资公司，它购买一个固定的（非管理的）收益型证券组合（通常是债券）并将其进行信托持有，这意味着 UIT 充当了投资者的控股公司。然后，该公司发行可赎回的股份（**单位 units**），代表投资者在信托中的权益。与共同基金不同，UIT 是为特定时间段设立的，并有固定的终止日期。任何资本利得、利息和/或股息都会定期传递给股东。
...
UITs 的流通股份数量有限，且在一级市场按首次公开募股 （IPO） 价格分销。由于流通股份数量有限，且必须向发行人或发起人赎回，因此其流动性非常有限。

Like mutual (open-end) funds, UITs can be purchased by type, such as growth, income, balanced, international, and so forth. Here are the two main categories of these trusts that you should be familiar with for the exam:
与共同（开放式）基金一样，UIT 也可以按类型购买，如增长型、收益型、平衡型、国际型等。以下是您在考试中应熟悉的这类信托的两大主要类别：

*   **Fixed investment trusts：** These companies invest in a portfolio of debt securities， and the trust terminates when all the bonds in the portfolio mature. （固定投资信托：这些公司投资于债务证券组合，当组合中的所有债券到期时，信托终止。）
*   **Participating trusts：** These companies invest in shares of mutual funds. The mutual funds that the trust holds don't change， but the securities held by the underlying mutual funds do. （参与型信托：这些公司投资于共同基金的股份。信托持有的共同基金本身不变，但这些共同基金底层持有的证券是变动的。）
...
🧠 **请记住**
由于证券组合是固定的，UIT 不雇佣投资顾问，因此在信托存续期内没有投资顾问费。这真不错！

---


## 10. Exchange-traded products (funds and notes) 10. 交易所交易产品（基金与票据）

Exchange-traded products (ETPs), which you're likely to encounter on the exam, include ETFs and exchange-traded notes (ETNs). ETPs are considered to be alternatives to investing in mutual funds; they not only provide diversification, like mutual funds but can also be sold short and purchased on margin. Investors should be aware, however, that they'll typically be charged a commission for buying and selling ETPs, which can really cut into any potential profits.
您在考试中可能会遇到的交易所交易产品 （ETPs） 包括 ETFs 和交易所交易票据 （ETNs）。ETPs 被认为是投资共同基金的替代方案；它们不仅像共同基金一样提供多样化，还可以进行卖空和融资买入。然而，投资者应意识到，买卖 ETPs 通常会被收取佣金，这可能会切实削减任何潜在利润。
...
### Exchange-traded funds (ETFs) 交易所交易基金 （ETFs）
...
交易所交易基金 （ETFs） 通常注册为开放式基金，但运作方式更像封闭式基金。它们要么被动跟踪指数或其他基准，要么由人工主动管理。正如其名，ETF 在交易所进行活跃交易。ETF 为投资者提供多样化选择，同时具备交易便利、可卖空以及可融资买入等特点。虽然 ETF 可以涵盖多个资产类别的投资，但其主要焦点在于股票（权益型基金）和债券（债券型基金）。
...
**反向 ETFs**（也称为**空头 ETFs** 或**熊市 ETFs**）是利用许多衍生产品（例如期权）设计的交易所交易基金，旨在从标的指数（例如标普 500）价值的下跌中获利。反向 ETF 可用于从大盘指数或特定行业（如能源或金融板块）的下跌中获利。
...
🧠 **请记住**
与共同基金相比，ETF 具有一些独特的优势，包括可以融资买入、交易便利以及运营成本较低。共同基金采用**远期定价**——这意味着申购或赎回是按下一个计算出的公开发售价 （POP） 或资产净值 （NAV） 进行的——但 ETF 可以在全天任何时间按当前的买入价或卖出价进行交易。
...
与共同基金相比，ETF 也存在一些缺点：投资者在买卖时通常会被收取佣金，而且由于交易非常方便，投资者更有可能过度交易而不是长期持有。（虽然有一些免佣金的 ETF，但它们通常拥有更高的费用率。）
...
**杠杆 ETFs** 旨在尝试返回其跟踪的基准指数（例如标普 500）每日收益的**倍数**。（想象一下乘法，如每日收益的 2 倍或 3 倍。）大多数杠杆和反向 ETF 的设计目标是按日实现的，这意味着基金持有的证券比其他基金更频繁地发生变动。
...
### Exchange-traded notes (ETNs) 交易所交易票据 （ETNs）
...
## 11. Investment company rules 17a-6 and 17a-7 11. 投资公司规则 17a-6 和 17a-7
...
对于投资公司的关联人员、顾问、高级职员和/或董事，有一些额外的规则——特别是 17a-6 和 17a-7 规则。请注意以下重要几点：
...
*   根据 **17a-6 规则**，投资公司的关联人员（与基金管理人、托管银行有关联的人员，以及持有基金 5% 或以上流通股的所有者）**不允许交易基金投资组合内的证券**。然而，关联人员当然被允许像普通公众投资者一样购买和赎回该基金的股份。
...
*   **17a-7 规则**规定，顾问、高级职员或董事可以交易同一基金家族内各基金持有的证券（例如，将富达旗下一只大盘价值基金组合中的证券交易给富达旗下的一只大盘混合基金，反之亦然）。
...
🧠 **请记住**
与其他证券一样，经纪自营商发布的所有投资公司广告必须经公司的**注册主管 （registered principal）** 批准。

---


## 12. Adding Annuities to a Portfolio 12. 将年金加入投资组合
...
年金与共同基金类似，不同之处在于年金旨在为投资者提供补充退休收入，且通常比共同基金更昂贵。人寿保险公司发行年金，这些投资为持有人的终身提供保证给付。SIE 考试会考查两种基本类型的年金：固定年金和变动年金。由于变动年金被视为证券，而固定年金则不然（因为保险公司保证给付），因此 SIE 考试中大多数关于年金的问题都是针对变动年金的。
...
**假设利率 （AIR）** 是对变动年金合同存续期内独立账户中证券表现的预测。如果假设利率为 4%，且独立账户中证券的表现等于 4%，则投资者收到预期的给付。然而，如果证券表现**优于 AIR**，投资者收到的**给付会高于预期**。不幸的是，如果独立账户中持有的证券表现**低于 AIR**，投资者收到的**给付会低于预期**。

---


## 13. Putting money into (and receiving money from) annuities 13. 向年金投入资金（并从中领取资金）
...
### The pay-in (accumulation) phase 投入（累积）阶段
...
向固定和变动年金的缴款都是由**税后资金**支付的，这意味着投资者不能在税收中扣除这些缴款。然而，固定和变动年金的投资收益都是在**税收递延 （tax-deferred）** 的基础上增长的。（在提取资金之前不会被征税。）如果一名投资者向变动年金投入了 80,000 美元，现在价值 120,000 美元，那么该投资者仅需对 40,000 美元的差额纳税，因为他们已经对投入的本金纳过税了。如果年金参加人在投入阶段死亡，大多数年金合同要求向其受益人支付**死亡给付 （death benefit）**。死亡给付通常是账户中所有资金或某个保证最低金额中的较大者。
...
注：在投入阶段，变动年金的投资者购买的是**累积单位 （accumulation units）**。您可以将累积单位想象成类似于共同基金的股份。

Investors have a few payment options to select when purchasing fixed or variable annuities. Here's the rundown of options:
在购买固定或变动年金时，投资者有几种支付选项可供选择。以下是选项汇总：

*   **Single payment deferred annuity：** An investor purchases the annuity with a lump-sum payment， and the payouts are delayed until some predetermined date. （一次性支付延期年金：投资者通过一次性缴款购买年金，给付延迟到某个预定日期开始。）
*   **Periodic payment deferred annuity：** An investor makes periodic payments （usually monthly） into the annuity， and the payouts are delayed until some predetermined date； this is the most common type of annuity. （定期支付延期年金：投资者向年金进行定期缴款（通常是每月），给付延迟到某个预定日期开始；这是最常见的年金类型。）
*   **Immediate annuity：** An investor purchases the annuity with a large sum， and the payouts begin right away or within a couple months. （即期年金：投资者投入一大笔资金购买年金，给付立即或在几个月内开始。）
...
固定年金和变动年金的投资者都有多种给付选项。这些选项可能仅涵盖**年金参加人**（投资者），或者涵盖年金参加人和一名**生存者**。无论投资者选择哪种给付选项，他们都将对超过投入本金的部分被征税。收益在税收递延的基础上增长，在退休提取之前，投资者不会对收益纳税。
...
注：在变动年金的领取阶段（**年金阶段 annuity phase**），累积单位被转换为固定数量的**年金单位 （annuity units）**。投资者定期（通常是每月）收到固定数量的年金单位，但其价值是变动的，取决于独立账户中证券的表现。
...
年金的种类（固定或变动）以及所选的给付选项在一定程度上决定了向年金参加人支付的金额。因此，在购买年金时，个人必须决定以下哪种给付选项最适合自己：
...
*   **终身年金（纯终身年金）：** 这种支付选项为年金参加人（年金覆盖的个人）提供终身收入；然而，在年金参加人死亡后，保险公司停止支付。这种类型的年金对**投资者来说风险最高**，因为如果年金参加人比预期早死，保险公司将保留剩余的年金资金。由于这对年金参加人来说是风险最高的年金类型，因此在所有选项中它的**给付额最高**。与联合生存年金一样，终身年金的支付金额基于年金参加人的年龄和性别。
...
*   **保底期限终身年金：** 这种给付选项保证向年金参加人支付**最低年限**（10 年、20 年等）。例如，如果年金参加人购买了具有 20 年保证期的年金，并在 7 年后死亡，指定的受益人将收到剩余 13 年的给付。
...
*   **联合生存年金 （Joint life with last survivor）：** 此选项保证对两个人的寿命进行给付。您可以想象，这种类型的年金通常是为配偶设立的。如果妻子先死，丈夫继续领取给付直到他去世。如果丈夫先死，他的妻子继续领取给付直到她去世。因为这种类型的年金覆盖了两个人的寿命，所以它的**给付额最低**。
...
### Being mindful of the early withdrawal penalty 留意提前支取罚款

As with most other retirement plans, annuity investors are hit with a **10 percent early withdrawal penalty** if they withdraw the money before age **59 1/2**. Yes, that's correct — the 10 percent penalty is added to the investor's tax bracket. Typically, annuities include a waiver of the 10 percent penalty in cases such as the need to cover long-term care expenses, death, or disability.
...
## 14. Understanding the Investment Component of Variable Life Insurance Products 14. 了解变动人寿保险产品的投资成分
...
您可能会奇怪，主要关于投资的 SIE 考试中为什么会出现人寿保险。答案是某些人寿保险产品（特别是**变动人寿保险 [VLI]** 和**变动万能寿险 [VUL]**）具有投资成分。与变动年金一样，变动人寿和变动万能寿险保单都有一个用于投资的**独立账户**。该独立账户与保险公司的通用基金分开存放。您不需要对上述保险产品了解太多，所以我将简要介绍。
...
### Variable life 变动人寿保险 （Variable life）
...
### Variable universal life 变动万能寿险 （Variable universal life）
...
与变动人寿保单不同，变动万能寿险保单**没有固定保费**。因此，它们有时被称为**灵活保费**变动人寿保单。与变动人寿保单一样，投资者可以选择独立账户中持有的证券。在这种情况下，由于保费不固定，且独立账户中持有的证券可能表现不佳，因此最低死亡给付和现金价值是**不保证的**。
...
## 15. Testing Your Knowledge 15. 知识测试
