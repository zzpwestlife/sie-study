# Part 5: Rules and Regulations 第 5 部分：规则与法规
...
## 1. Meeting the Market Watchdogs: Securities Regulatory Organizations 1. 会见市场监管机构：证券监管组织

To keep the market running smoothly and to make sure investors aren’t abused, regulatory organizations stay on the lookout.
为了确保市场平稳运行并防止投资者受到（哪怕是一点点）侵害，监管组织始终保持警惕。
...
Persons wanting to register as financial professionals must submit a **U4 form**. The application includes a ten-year employment history and a five-year residential history. Applicants must also submit their **fingerprints**.
希望注册为金融专业人士的人员必须提交 **U4 表格**。申请内容包括十年的就业历史和五年的居住历史。申请人还必须提交其**指纹**。

🧠 **REMEMBER**
A person will be **statutorily disqualified** from membership if they had a **felony criminal conviction** or certain misdemeanor convictions (involving money or securities) within the last **ten years**.
🧠 **请记住**
如果在过去**十年内**曾受到**重罪刑事指控**或某些特定的轻罪指控（涉及金钱或证券），该人员将被**法定取消资格 （statutorily disqualified）** 成员身份。


### Continuing education 后续教育 (Continuing education)
...
## 3. Trading and Account Handling Rules 3. 交易与账户处理规则


### Order Tickets 订单票据 (Order Tickets)
...
### Regulation S-P (Privacy) S-P 条例 (隐私)
...
### Regulation BI (Best Interest) BI 条例 (最大利益)
...
### Financial Exploitation of Seniors 对老年人的金融剥削
...
### Trade Confirmations and Statements 交易确认书与对账单
...
*   **Institutional communication**： Written communication distributed only to institutional investors。 （机构沟通：仅分发给机构投资者的书面沟通。）

---


## 5. Record Keeping 5. 记录保存
...
*   **Three-year records**： Order tickets， trade confirmations， U4/U5 forms， and advertisements。 （三年记录：订单委托单、交易确认书、U4/U5 表格以及广告。）

🧠 **REMEMBER**
Records have to be **easily accessible for two years**.
🧠 **请记住**
记录必须在**头两年内易于获取**。
...
## 6. Sticking to the 5 percent markup policy 6. 坚持 5% 的加价政策
...
*   **Difficulty**： Experiencing difficulty buying or selling the security because the market price is too low or too high。 （难度：因市场价格过低或过高导致买卖证券困难。）
*   **Small trades**： Handling a small trade （e。g。， a $100 order）。 （小额交易：处理小额订单。）
*   **Locating**： Encountering difficulty locating and purchasing a specific security。 （寻券：寻找并购买特定证券遇到困难。）
*   **Liquidity**： Trading nonliquid securities。 （流动性：交易流动性差的证券。）
...
## 8. Avoiding violations 8. 避免违规行为
...
## 9. Anti-money-laundering (AML) rules 9. 反洗钱 (AML) 规则

Here are the three stages of money laundering:
洗钱的三个阶段如下：

1。  **Placement**： Funds are transferred into the financial system。 （放置：资金进入金融系统。）
2。  **Layering**： Disguising the source of funds through multiple transactions。 （离析/分层：通过多次交易掩盖资金来源。）
3。  **Integration**： Illegal funds are mixed with legitimate funds。 （融合：非法资金与合法资金混合。）

🧠 **REMEMBER**
*   **CTR (Currency Transaction Report)**: Report cash transactions of **more than $10,000** in a single day.
*   **SAR (Suspicious Activity Report)**: Report suspicious activity of **$5,000 or more**.
🧠 **请记住**
*   **CTR（货币交易报告）**：单日报告**超过 10,000 美元**的现金交易。
*   **SAR（可疑活动报告）**：报告 **5,000 美元或以上**的可疑活动。

---


## 10. Working with public info: Following insider trading rules 10. 处理公共信息：遵循内幕交易规则
...
🧠 **REMEMBER**
**Penalties**:
*   Criminal: Up to **$5 million** fine and **20 years** in prison.
*   Civil: **Three times** the gain or loss avoided (treble damages).
🧠 **请记住**
**处罚**：
*   刑事：最高 **500 万美元**罚金及 **20 年**监禁。
*   民事：获利或避免损失金额的**三倍**（惩罚性赔偿）。

---


## 11. The Investor’s Bankruptcy Shield: FDIC and SIPC Coverage 11. 投资者的破产护盾：FDIC 与 SIPC 保障
...
## 12. Keeping your dividend dates straight 12. 理清股息日期

💡 **TIP**
To help you remember the sequence, use the phrase **"Don’t Eat Rubber Pickles"**:
**D**eclaration, **E**x-dividend, **R**ecord, **P**ayment.
💡 **提示**
为了帮助您记住顺序，请使用短语 **"Don’t Eat Rubber Pickles"**（别吃橡胶腌菜）：
**D**eclaration（宣布日）， **E**x-dividend（除息日）， **R**ecord（登记日）， **P**ayment（支付日）。

---


## 13. Testing Your Knowledge 13. 知识测试
...
1.  股票订单票据上需要包含以下哪些内容？
   ...
   (C) II, III, 和 IV
   (D) I, II, III, 和 IV
2. All of the following are self-regulatory organizations EXCEPT
   (A) NYSE
   (B) SEC
   (C) MSRB
   (D) FINRA
2.  以下所有都是自律组织 (SRO)，除了：
   ...
   (C) MSRB
   (D) FINRA
3. Declan Smith has an account at Ayla Broker-Dealer. Declan has not traded any securities at Ayla Broker-Dealer for over three years. How often is Ayla Broker-Dealer required to send an account statement to Declan?
   (A) Monthly
   (B) Quarterly
   (C) Semiannually
   (D) Annually
3.  Declan Smith 在 Ayla 经纪交易商处有一个账户。Declan 已经三年多没有在 Ayla 交易任何证券了。Ayla 经纪交易商需要多久向 Declan 发送一次对账单？
   (A) 每月
   (B) 每季度
   (C) 每半年
   (D) 每年
4. The ex-dividend date is _______ business day(s) before the record date.
   (A) one
   (B) two
   (C) three
   (D) five
4.  除息日是在股权登记日之前的 _______ 个工作日。
...
5. Which of the following is a violation that includes a form of market manipulation?
   ...
   (C) Pump and dump
   (D) Interpositioning
5.  以下哪项是包含市场操纵形式的违规行为？
   (A) 混合资金 (Commingling)
   (B) 抢先交易 (Frontrunning)
   (C) 拉高出货 (Pump and dump)
   (D) 嵌位交易 (Interpositioning)
6. Which of the following are subject to the FINRA 5 percent markup policy?
...
6.  以下哪些受 FINRA（美国金融业监管局）5% 加价政策的约束？
   ...
   (C) I, III, 和 IV
   (D) I, II, III, 和 IV
7. Which of the following is an indication of money laundering when a customer opens an account?
   (A) Concern with U.S. government reporting requirements
   (B) Reluctance to reveal information about business activities
   (C) Questionable ID
   (D) All of the above
7.  以下哪项是客户开户时可能表明存在洗钱风险的迹象？
   (A) 关注美国政府的报告要求
   (B) 不愿透露业务活动信息
   (C) 可疑的身份证明
   (D) 以上所有
8. A person will be statutorily disqualified from membership from FINRA under which of the following circumstances?
...
8.  在以下哪种情况下，个人将被法定取消 FINRA（美国金融业监管局）会员资格？
   ...
   (C) I 和 II
   (D) I, II, 和 III
9. If you resign from a brokerage firm, how long do you have to register with another firm so that you don't have to take your securities exams again?
   (A) 90 days
   (B) 6 months
   (C) 1 year
   (D) 2 years
9.  如果您从经纪公司辞职，您需要在多长时间内注册到另一家公司才能不必重新参加证券考试？
   (A) 90 天
   (B) 6 个月
   (C) 1 年
   (D) 2 年
...
11. 以下哪种证券交易在交易日后两个工作日结算？
    ...
    (C) I, III, 和 IV
    (D) I, II, III, 和 IV
12. Which of the following are types of communications that are required to be preserved for a minimum of three years?
    I. Email
    II. Instant messages
    III. Text messages
...
12. 以下哪些类型的通信需要保存至少三年？
    ...
    (C) I, II, 和 III
    (D) I, II, III, 和 IV
13. A customer wants to open a new account and is adding a new account feature. Which of the following documents must the customer sign?
    (A) New account application form
    (B) Options agreement
    (C) Margin agreement
    (D) All of the above
13. 客户想要开设新账户并添加新的账户功能。客户必须签署以下哪些文件？
    (A) 新账户申请表
    (B) 期权协议
    (C) 保证金协议
    (D) 以上所有
14. Which of the following is a requirement for a customer complaint?
    (A) It must be acknowledged within 10 business days
    (B) It must be investigated within 30 days
    (C) It must be reported to FINRA immediately
    (D) It must be kept in the customer's file
14. 以下哪项是客户投诉的要求？
    (A) 必须在 10 个工作日内确认收到
    (B) 必须在 30 天内调查
...
15. Which of the following best describes the purpose of the Bank Secrecy Act (BSA)?
    ...
    (C) To protect investors from fraud
    (D) To ensure fair trading practices
15. 以下哪项最好地描述了《银行保密法》(BSA) 的目的？
    (A) 监管证券行业
    (B) 防止洗钱
    (C) 保护投资者免受欺诈
    (D) 确保公平交易惯例
16. Which of the following is a characteristic of insider trading?
    (A) Trading based on public information
    (B) Trading based on nonpublic, material information
    (C) Trading based on analyst recommendations
    (D) Trading based on historical price patterns
16. 以下哪项是内幕交易的特征？
    (A) 基于公开信息进行交易
    (B) 基于非公开的重大信息进行交易
    (C) 基于分析师推荐进行交易
    (D) 基于历史价格模式进行交易
17. Which of the following is TRUE about the SIPC (Securities Investor Protection Corporation)?
    (A) It regulates the securities industry
    (B) It provides insurance for customer securities
    (C) It investigates securities fraud
    (D) It sets listing standards for exchanges
17. 关于 SIPC（证券投资者保护公司），以下哪项是正确的？
    (A) 它监管证券行业
    (B) 它为客户证券提供保险
    (C) 它调查证券欺诈
    (D) 它为交易所设定上市标准
18. What is the purpose of the PATRIOT Act in relation to broker-dealers?
    (A) To increase market transparency
    (B) To enhance customer identification procedures
    (C) To regulate option trading
    (D) To set margin requirements
18. 《爱国者法案》与经纪交易商相关的目的是什么？
    (A) 增加市场透明度
    (B) 加强客户识别程序
    (C) 规范期权交易
    (D) 设定保证金要求
19. What are the potential penalties for insider trading violations?
    (A) fines only
    (B) imprisonment only
...
19. 内幕交易违规的潜在处罚是什么？
    ...
    (C) 罚款和监禁
    (D) 无处罚
20. Which of the following is an example of market manipulation?
    (A) Scalping
    (B) Churning
    (C) Painting the tape
    (D) All of the above
20. 以下哪项是市场操纵的例子？
    ...
    (C) 虚张声势
    (D) 以上所有
21. What is the practice of "freeriding"?
    (A) Buying securities on margin without sufficient funds
    (B) Selling securities that you don't own
    (C) Using customer funds for personal trading
    (D) Trading ahead of customer orders
21. "搭便车"的做法是什么？
    (A) 在没有足够资金的情况下融资购买证券
    (B) 卖空不拥有的证券
    (C) 将客户资金用于个人交易
    (D) 在客户订单之前进行交易
22. What information must be included in a brokerage firm's emergency contact plan?
    (A) Names and contact information for two principals
    (B) List of all customer accounts
    (C) Trading algorithms used by the firm
    (D) Compensation structure for employees
22. 经纪公司紧急联系计划必须包含哪些信息？
    (A) 两名负责人的姓名和联系方式
    (B) 所有客户账户列表
    (C) 公司使用的交易算法
    (D) 员工薪酬结构
23. What is the coverage limit for SIPC protection?
    (A) $100,000 per customer
    (B) $250,000 per customer
    (C) $500,000 per customer
    (D) $1,000,000 per customer
23. SIPC 保护的承保限额是多少？
    (A) 每位客户 100,000 美元
    (B) 每位客户 250,000 美元
    (C) 每位客户 500,000 美元
    (D) 每位客户 1,000,000 美元
24. How long must broker-dealers keep records of trades and account transactions?
    (A) Minimum of 3 years
    (B) Minimum of 5 years
    (C) Minimum of 6 years
    (D) Minimum of 10 years
24. 经纪交易商必须保存交易和账户交易记录多长时间？
    (A) 最少 3 年
    (B) 最少 5 年
    (C) 最少 6 年
    (D) 最少 10 年
25. Which documents must be kept for the life of the brokerage firm?
    (A) Trade records
    (B) Corporate or partnership documents
    (C) Customer account statements
    (D) All of the above
25. 必须在经纪公司存续期间保存哪些文件？
    (A) 交易记录
    (B) 公司或合伙文件
    (C) 客户对账单
    (D) 以上所有
...
6.  **D.** 列出的所有四种交易类型都受 5% 加价指导原则的约束。
7.  **D.** All of the above (concern about reporting, reluctance to provide information, and questionable ID) can be indicators of money laundering.
7.  **D.** 以上所有（关注报告要求、不愿提供信息、可疑身份证明）都可能是洗钱的迹象。
8.  **D.** All three circumstances (felony conviction, barred from SRO membership, false statements) can result in statutory disqualification.
8.  **D.** 所有三种情况（重罪定罪、被自律组织禁止会员资格、虚假陈述）都可能导致法定取消资格。
9.  **A.** If you resign from a brokerage firm, you have 90 days to register with another firm to maintain your securities registration.
9.  **A.** 如果您从经纪公司辞职，您有 90 天时间在另一家公司注册以保持您的证券注册资格。
...
13. **D.** 客户在开设新账户或添加新的账户功能时必须签署所有相关文件。
14. **A.** Customer complaints must be acknowledged within 10 business days.
14. **A.** 客户投诉必须在 10 个工作日内确认收到。
15. **B.** The Bank Secrecy Act (BSA) is primarily designed to prevent money laundering.
15. **B.** 《银行保密法》(BSA) 主要旨在防止洗钱。
16. **B.** Insider trading involves trading based on nonpublic, material information.
16. **B.** 内幕交易涉及基于非公开的重大信息进行交易。
17. **B.** SIPC provides insurance for customer securities up to $500,000 (including $250,000 for cash).
17. **B.** SIPC 为客户证券提供最高 500,000 美元的保险（包括 250,000 美元现金）。
18. **B.** The PATRIOT Act requires broker-dealers to implement enhanced customer identification procedures.
18. **B.** 《爱国者法案》要求经纪交易商实施加强的客户识别程序。
19. **C.** Penalties for insider trading can include both civil penalties and criminal imprisonment.
19. **C.** 内幕交易的处罚可能包括民事罚款和刑事监禁。
20. **D.** All of the above (scalping, churning, painting the tape) are forms of market manipulation.
20. **D.** 以上所有（抢帽子交易、过度交易、虚张声势）都是市场操纵的形式。
21. **A.** Freeriding is the practice of buying securities on margin without having sufficient funds to cover the transaction.
21. **A.** 搭便车是在没有足够资金覆盖交易的情况下融资购买证券的做法。
22. **A.** Brokerage firms must have a plan that includes names and contact information for two principals who can be reached in case of emergency.
22. **A.** 经纪公司必须有一个计划，包括两名负责人的姓名和联系方式，以便在紧急情况下联系。
23. **C.** SIPC provides protection up to $500,000 per customer, including $250,000 for cash holdings.
23. **C.** SIPC 为每位客户提供最高 500,000 美元的保障，包括 250,000 美元的现金持有。
24. **C.** Records of trades and account transactions must be kept for a minimum of six years.
24. **C.** 交易和账户交易记录必须至少保存六年。
25. **B.** Corporate or partnership documents must be kept for the life of the brokerage firm.
25. **B.** 公司或合伙文件必须在经纪公司存续期间保存。
...
### Additional Answers Additional Answers [需要翻译]
